# Promotion Calibration Brief

## Use when
Use this workflow when you are working on People Systems That Actually Raise the Bar and need to produce a reusable decision brief or operating spec. Its distinct job inside the People Systems Pack is to produce the promotion calibration brief; use the neighboring skills for Talent Bar Definition, Hiring Signal Scorecard, Performance System Review.
...
- Domain signals to inspect: scope evidence, bar comparison, readiness risk, peer calibration, decision right.
...
3. Inspect the domain mechanics for this pack: scope evidence, bar comparison, readiness risk, peer calibration, decision right. Call out where handoffs, incentives, review gates, or decision rights break down.
4. Separate this skill's job from the rest of the pack: deliver the promotion calibration brief, and list what should be routed to Talent Bar Definition, Hiring Signal Scorecard, Performance System Review.
...
## Output
Return a promotion calibration brief with this schema:
- `use_case`: the specific operating situation and decision.
- `evidence`: facts, source links, missing data, and assumption flags.
- `diagnosis`: what is happening, why it matters, and which scope evidence signal changed.
...
## Failure modes
- Producing a generic consultant summary instead of a decision-ready promotion calibration brief tied to scope evidence.
- Treating stale dashboards, anecdotes, or meeting memory as facts without source-of-truth checks.
- Blurring this skill with Talent Bar Definition, Hiring Signal Scorecard, Performance System Review, which creates duplicate work and hides the real owner.
- Skipping the human review gate for commitments, sensitive people/customer data, or system-of-record changes.

## Example prompt
Run the Promotion Calibration Brief workflow for the following People Systems That Actually Raise the Bar situation. Context: <describe team, decision, deadline, evidence links, owner, and known constraints>. Return the promotion calibration brief using the output schema, mark assumptions, and list the human review gates before anyone acts.
