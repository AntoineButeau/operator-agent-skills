# Meeting Dynamics Review

## Use when
Use this workflow when you are working on Social Awareness for Operators and need to diagnose the current state and name the operating risk. Its distinct job inside the Social Awareness Operator Pack is to produce the meeting dynamics review; use the neighboring skills for Room Read Map, Stakeholder Empathy Brief, Social Signal Risk Scan.
...
- Domain signals to inspect: participation pattern, silence, coalition, conflict cue, decision energy.
...
3. Inspect the domain mechanics for this pack: participation pattern, silence, coalition, conflict cue, decision energy. Call out where handoffs, incentives, review gates, or decision rights break down.
4. Separate this skill's job from the rest of the pack: deliver the meeting dynamics review, and list what should be routed to Room Read Map, Stakeholder Empathy Brief, Social Signal Risk Scan.
...
## Output
Return a meeting dynamics review with this schema:
- `use_case`: the specific operating situation and decision.
- `evidence`: facts, source links, missing data, and assumption flags.
- `diagnosis`: what is happening, why it matters, and which participation pattern signal changed.
...
## Failure modes
- Producing a generic consultant summary instead of a decision-ready meeting dynamics review tied to participation pattern.
- Treating stale dashboards, anecdotes, or meeting memory as facts without source-of-truth checks.
- Blurring this skill with Room Read Map, Stakeholder Empathy Brief, Social Signal Risk Scan, which creates duplicate work and hides the real owner.
- Skipping the human review gate for commitments, sensitive people/customer data, or system-of-record changes.

## Example prompt
Run the Meeting Dynamics Review workflow for the following Social Awareness for Operators situation. Context: <describe team, decision, deadline, evidence links, owner, and known constraints>. Return the meeting dynamics review using the output schema, mark assumptions, and list the human review gates before anyone acts.
