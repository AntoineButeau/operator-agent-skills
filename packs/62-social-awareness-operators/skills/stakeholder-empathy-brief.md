# Stakeholder Empathy Brief

## Use when
Use this workflow when you are working on Social Awareness for Operators and need to produce a reusable decision brief or operating spec. Its distinct job inside the Social Awareness Operator Pack is to produce the empathy brief; use the neighboring skills for Room Read Map, Social Signal Risk Scan, Meeting Dynamics Review.
...
- Domain signals to inspect: incentive, fear, constraint, identity stake, win condition.
...
3. Inspect the domain mechanics for this pack: incentive, fear, constraint, identity stake, win condition. Call out where handoffs, incentives, review gates, or decision rights break down.
4. Separate this skill's job from the rest of the pack: deliver the empathy brief, and list what should be routed to Room Read Map, Social Signal Risk Scan, Meeting Dynamics Review.
...
## Output
Return a empathy brief with this schema:
- `use_case`: the specific operating situation and decision.
- `evidence`: facts, source links, missing data, and assumption flags.
- `diagnosis`: what is happening, why it matters, and which incentive signal changed.
...
## Failure modes
- Producing a generic consultant summary instead of a decision-ready empathy brief tied to incentive.
- Treating stale dashboards, anecdotes, or meeting memory as facts without source-of-truth checks.
- Blurring this skill with Room Read Map, Social Signal Risk Scan, Meeting Dynamics Review, which creates duplicate work and hides the real owner.
- Skipping the human review gate for commitments, sensitive people/customer data, or system-of-record changes.

## Example prompt
Run the Stakeholder Empathy Brief workflow for the following Social Awareness for Operators situation. Context: <describe team, decision, deadline, evidence links, owner, and known constraints>. Return the empathy brief using the output schema, mark assumptions, and list the human review gates before anyone acts.
