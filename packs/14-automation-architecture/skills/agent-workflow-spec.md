...
## Use when
Use this workflow when you are working on automation / ai automation architecture and need to produce a reusable artifact or operating spec. Its distinct job inside the Automation Design Pack is to produce the implementation-ready spec; use the neighboring skills for Automation Opportunity Scan, Human-in-the-Loop Design, Automation ROI Brief.
...
4. Separate this skill's job from the rest of the pack: deliver the implementation-ready spec, and list what should be routed to Automation Opportunity Scan, Human-in-the-Loop Design, Automation ROI Brief.
