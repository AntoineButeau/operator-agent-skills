...
## Use when
Use this workflow when a human workflow needs conversion into an agent-executable process.
...
## Output
an agent workflow specification. Include the decision, owner, next action, review date, and open questions.
