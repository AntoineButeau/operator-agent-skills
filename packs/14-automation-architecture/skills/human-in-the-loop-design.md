...
## Use when
Use this workflow when automation needs review gates and safe escalation rather than full autonomy.

## Inputs
- Primary objective or decision to support
- task, risk level, failure cost, reviewer roles
...
## Output
a control design with review and rollback points. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Human-in-the-Loop Design workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
