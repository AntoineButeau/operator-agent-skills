# Automation ROI Brief

## Use when
Use this workflow when you are working on automation / ai automation architecture and need to compress the situation into a decision-ready brief. Its distinct job inside the Automation Design Pack is to produce the operator memo; use the neighboring skills for Automation Opportunity Scan, Human-in-the-Loop Design, Agent Workflow Spec.
...
4. Separate this skill's job from the rest of the pack: deliver the operator memo, and list what should be routed to Automation Opportunity Scan, Human-in-the-Loop Design, Agent Workflow Spec.
