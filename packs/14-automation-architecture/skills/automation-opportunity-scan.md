...
## Use when
Use this workflow when you are working on automation / ai automation architecture and need to diagnose the current state and name the operating risk. Its distinct job inside the Automation Design Pack is to produce the risk-and-evidence audit; use the neighboring skills for Human-in-the-Loop Design, Automation ROI Brief, Agent Workflow Spec.
...
4. Separate this skill's job from the rest of the pack: deliver the risk-and-evidence audit, and list what should be routed to Human-in-the-Loop Design, Automation ROI Brief, Agent Workflow Spec.
