...
## Use when
Use this workflow when sales or success needs better product-led account signals.

## Inputs
- Primary objective or decision to support
- usage events, account attributes, historical conversions
...
## Output
a PQL definition and routing rule. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Product-Qualified Signal Design workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
