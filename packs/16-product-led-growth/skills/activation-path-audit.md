...
## Use when
Use this workflow when users sign up but do not reach meaningful value quickly.
...
## Output
an activation diagnosis and experiment list. Include the decision, owner, next action, review date, and open questions.
