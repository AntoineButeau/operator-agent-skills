...
## Use when
Use this workflow when free or trial users need a clearer path to paid conversion.
...
## Output
a conversion map and pricing triggers. Include the decision, owner, next action, review date, and open questions.
