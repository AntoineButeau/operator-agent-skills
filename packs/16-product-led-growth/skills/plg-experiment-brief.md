...
## Use when
Use this workflow when a growth experiment needs tight framing and learning value.

## Inputs
- Primary objective or decision to support
- hypothesis, segment, metric, intervention, duration
...
## Output
an experiment brief and decision rule. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the PLG Experiment Brief workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
