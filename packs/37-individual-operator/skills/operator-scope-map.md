...
## Use when
Use this workflow when you are working on from individual contributor to individual operator and need to make the system visible by mapping owners, flows, and evidence. Its distinct job inside the Individual Operator Pack is to produce the owner-and-flow map; use the neighboring skills for Work Legibility Update, Autonomy Readiness Plan, Operator Retrospective.
...
4. Separate this skill's job from the rest of the pack: deliver the owner-and-flow map, and list what should be routed to Work Legibility Update, Autonomy Readiness Plan, Operator Retrospective.
