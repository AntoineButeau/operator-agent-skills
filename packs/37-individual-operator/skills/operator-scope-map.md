...
## Use when
Use this workflow when an IC needs to expand from assigned tasks to owned outcomes.

## Inputs
- Primary objective or decision to support
- role, goals, stakeholders, current responsibilities
...
## Output
an operator scope map. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Operator Scope Map workflow for this situation: [paste context]. Return the artifact, the recommendation, and the questions a human should answer before acting.
