...
## Use when
Use this workflow when you are working on from individual contributor to individual operator and need to turn the decision into sequenced work with gates and owners. Its distinct job inside the Individual Operator Pack is to produce the sequenced operating plan; use the neighboring skills for Operator Scope Map, Work Legibility Update, Operator Retrospective.
...
- Domain signals to inspect: work legibility, operator scope, autonomy readiness, retrospective, manager update.
...
3. Inspect the domain mechanics for this pack: work legibility, operator scope, autonomy readiness, retrospective, manager update. Call out where handoffs, incentives, review gates, or decision rights break down.
4. Separate this skill's job from the rest of the pack: deliver the sequenced operating plan, and list what should be routed to Operator Scope Map, Work Legibility Update, Operator Retrospective.
...
- `diagnosis`: what is happening, why it matters, and which work legibility signal changed.
...
## Failure modes
- Producing a generic consultant summary instead of a decision-ready sequenced operating plan tied to work legibility.
- Treating stale dashboards, anecdotes, or meeting memory as facts without source-of-truth checks.
- Blurring this skill with Operator Scope Map, Work Legibility Update, Operator Retrospective, which creates duplicate work and hides the real owner.
- Skipping the human review gate for commitments, sensitive people/customer data, or system-of-record changes.

## Example prompt
Run the Autonomy Readiness Plan workflow for the following From Individual Contributor to Individual Operator situation. Context: <describe team, decision, deadline, evidence links, owner, and known constraints>. Return the sequenced operating plan using the output schema, mark assumptions, and list the human review gates before anyone acts.
