...
## Use when
Use this workflow when you are working on from individual contributor to individual operator and need to produce a reusable artifact or operating spec. Its distinct job inside the Individual Operator Pack is to produce the implementation-ready spec; use the neighboring skills for Operator Scope Map, Work Legibility Update, Autonomy Readiness Plan.
...
4. Separate this skill's job from the rest of the pack: deliver the implementation-ready spec, and list what should be routed to Operator Scope Map, Work Legibility Update, Autonomy Readiness Plan.
