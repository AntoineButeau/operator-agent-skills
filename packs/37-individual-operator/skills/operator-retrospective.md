...
## Use when
Use this workflow when an IC wants to learn from a project as an operator rather than just a contributor.
...
## Output
a retrospective and operating lessons. Include the decision, owner, next action, review date, and open questions.
