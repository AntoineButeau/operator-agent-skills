# Work Legibility Update

## Use when
Use this workflow when you are working on from individual contributor to individual operator and need to compress the situation into a decision-ready brief. Its distinct job inside the Individual Operator Pack is to produce the operator memo; use the neighboring skills for Operator Scope Map, Autonomy Readiness Plan, Operator Retrospective.
...
4. Separate this skill's job from the rest of the pack: deliver the operator memo, and list what should be routed to Operator Scope Map, Autonomy Readiness Plan, Operator Retrospective.
