...
## Use when
Use this workflow when important work needs to be visible to leadership without performative noise.

## Inputs
- Primary objective or decision to support
- workstream, progress, risks, decisions, asks
...
## Output
a legible work update. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Work Legibility Update workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
