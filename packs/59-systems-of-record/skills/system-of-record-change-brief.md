# System of Record Change Brief

## Use when
Use this workflow when you are working on Systems of Record: Who Owns the Truth? and need to produce a reusable decision brief or operating spec. Its distinct job inside the Systems of Record Pack is to produce the change brief; use the neighboring skills for Source of Truth Map, Record Ownership Review, Truth Conflict Resolution Plan.
...
- Domain signals to inspect: migration, field change, integration, user workflow, rollback.
...
3. Inspect the domain mechanics for this pack: migration, field change, integration, user workflow, rollback. Call out where handoffs, incentives, review gates, or decision rights break down.
4. Separate this skill's job from the rest of the pack: deliver the change brief, and list what should be routed to Source of Truth Map, Record Ownership Review, Truth Conflict Resolution Plan.
...
## Output
Return a change brief with this schema:
- `use_case`: the specific operating situation and decision.
- `evidence`: facts, source links, missing data, and assumption flags.
- `diagnosis`: what is happening, why it matters, and which migration signal changed.
