# Culture Operating Gap Review

## Use when
Use this workflow when you are working on how companies actually behave: operating principles, decision rules, and the hidden system behind culture and need to diagnose the current state and name the operating risk. Its distinct job inside the Behavioral OS Pack is to produce the risk-and-evidence audit; use the neighboring skills for Revealed Behavior Audit, Decision Rule Extractor, Behavior Change Lever Map.
...
4. Separate this skill's job from the rest of the pack: deliver the risk-and-evidence audit, and list what should be routed to Revealed Behavior Audit, Decision Rule Extractor, Behavior Change Lever Map.
