...
## Use when
Use this workflow when leaders need to change behavior through incentives, defaults, and constraints.

## Inputs
- Primary objective or decision to support
- target behavior, current behavior, blockers, rewards
...
## Output
a lever map and intervention plan. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Behavior Change Lever Map workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
