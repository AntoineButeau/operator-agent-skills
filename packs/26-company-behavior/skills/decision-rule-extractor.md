...
## Use when
Use this workflow when an organization needs to name the unwritten rules driving behavior.
...
## Output
a set of explicit decision rules. Include the decision, owner, next action, review date, and open questions.
