...
## Use when
Use this workflow when a change needs an adoption system beyond a launch message.

## Inputs
- Primary objective or decision to support
- change rationale, user groups, behavior shifts, support needs
...
## Output
an adoption plan with phases. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Announcement to Adoption Plan workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
