...
## Use when
Use this workflow when people are resisting a change and leaders need to know why.

## Inputs
- Primary objective or decision to support
- feedback, stakeholder map, incentives, constraints
...
## Output
a resistance diagnosis and response options. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Resistance Diagnosis workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
