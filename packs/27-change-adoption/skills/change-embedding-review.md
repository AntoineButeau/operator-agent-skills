# Change Embedding Review

## Use when
Use this workflow when you are working on change that actually takes: how companies move from announcement to adoption and need to diagnose the current state and name the operating risk. Its distinct job inside the Change Adoption Pack is to produce the risk-and-evidence audit; use the neighboring skills for Change Readiness Scan, Announcement to Adoption Plan, Resistance Diagnosis.
...
4. Separate this skill's job from the rest of the pack: deliver the risk-and-evidence audit, and list what should be routed to Change Readiness Scan, Announcement to Adoption Plan, Resistance Diagnosis.
