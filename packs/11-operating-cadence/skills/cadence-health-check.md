...
## Use when
Use this workflow when an operating system is decaying or failing to surface issues early.
...
## Output
a health report and repair plan. Include the decision, owner, next action, review date, and open questions.
