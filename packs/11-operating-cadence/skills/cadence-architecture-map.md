# Cadence Architecture Map

## Use when
Use this workflow when you are working on operating cadence & management systems and need to make the system visible by mapping owners, flows, and evidence. Its distinct job inside the Operating Cadence Pack is to produce the owner-and-flow map; use the neighboring skills for Weekly Business Review Design, Meeting System Prune, Cadence Health Check.
...
4. Separate this skill's job from the rest of the pack: deliver the owner-and-flow map, and list what should be routed to Weekly Business Review Design, Meeting System Prune, Cadence Health Check.
