...
## Use when
Use this workflow when meetings and reviews exist but do not connect strategy, decisions, and execution.

## Inputs
- Primary objective or decision to support
- meeting list, reports, planning cycles, decision forums
...
## Output
a cadence map with purpose, inputs, outputs, and owners. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Cadence Architecture Map workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
