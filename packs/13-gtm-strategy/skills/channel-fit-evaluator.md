...
## Use when
Use this workflow when a team needs to choose channels based on buyer behavior and economics.

## Inputs
- Primary objective or decision to support
- buyer journey, ACV, sales cycle, capabilities
- Known constraints, deadlines, buyers, sellers, marketers, and GTM leaders, and risk tolerance
...
## Output
a channel-fit scorecard. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Channel Fit Evaluator workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
