...
## Use when
Use this workflow when strategy needs translation into near-term execution.

## Inputs
- Primary objective or decision to support
- targets, resources, funnel assumptions, milestones
...
## Output
a quarterly GTM operating plan. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the GTM Operating Plan workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
