...
## Use when
Use this workflow when a company needs a coherent go-to-market thesis before executing tactics.

## Inputs
- Primary objective or decision to support
- ICP, pain, category, channels, sales motion, proof
...
## Output
a GTM thesis memo. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the GTM Thesis Builder workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
