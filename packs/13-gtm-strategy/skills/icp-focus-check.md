...
## Use when
Use this workflow when pipeline or product messaging is scattered across too many buyer types.

## Inputs
- Primary objective or decision to support
- customers, win/loss, use cases, deal quality
...
## Output
a focused ICP recommendation. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the ICP Focus Check workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
