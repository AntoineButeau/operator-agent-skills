...
## Use when
Use this workflow when you are working on personal productivity + knowledge management and need to diagnose the current state and name the operating risk. Its distinct job inside the Personal Knowledge OS Pack is to produce the risk-and-evidence audit; use the neighboring skills for Capture Purpose Filter, Notes to Output Pipeline, System Decay Triage.
...
4. Separate this skill's job from the rest of the pack: deliver the risk-and-evidence audit, and list what should be routed to Capture Purpose Filter, Notes to Output Pipeline, System Decay Triage.
...
## Failure modes
- Producing a generic consultant summary instead of a decision-ready risk-and-evidence audit tied to capture inbox.
- Treating stale dashboards, anecdotes, or meeting memory as facts without source-of-truth checks.
- Blurring this skill with Capture Purpose Filter, Notes to Output Pipeline, System Decay Triage, which creates duplicate work and hides the real owner.
