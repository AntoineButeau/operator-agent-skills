...
## Use when
Use this workflow when tasks, notes, and commitments are decaying because the review loop is weak.
...
## Output
a 30-minute weekly review checklist and reset plan. Include the decision, owner, next action, review date, and open questions.
