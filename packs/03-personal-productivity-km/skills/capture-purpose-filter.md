...
## Use when
Use this workflow when a knowledge system is collecting too much and producing too little.

## Inputs
- Primary objective or decision to support
- capture sources, active projects, outputs expected, review habits
...
## Output
a capture policy that separates reference, action, and creation material. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Capture Purpose Filter workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
