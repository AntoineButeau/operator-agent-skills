...
## Use when
Use this workflow when you are working on Competitive Strategy and need to produce a reusable decision brief or operating spec. Its distinct job inside the Competitive Strategy Pack is to produce the response brief; use the neighboring skills for Competitive Position Map, Moat Evidence Review, Strategy War Game.
...
- Domain signals to inspect: threat, response option, timing, cost, narrative.
...
3. Inspect the domain mechanics for this pack: threat, response option, timing, cost, narrative. Call out where handoffs, incentives, review gates, or decision rights break down.
4. Separate this skill's job from the rest of the pack: deliver the response brief, and list what should be routed to Competitive Position Map, Moat Evidence Review, Strategy War Game.
...
## Failure modes
- Producing a generic consultant summary instead of a decision-ready response brief tied to threat.
- Treating stale dashboards, anecdotes, or meeting memory as facts without source-of-truth checks.
- Blurring this skill with Competitive Position Map, Moat Evidence Review, Strategy War Game, which creates duplicate work and hides the real owner.
- Skipping the human review gate for commitments, sensitive people/customer data, or system-of-record changes.

## Example prompt
Run the Competitive Response Brief workflow for the following Competitive Strategy situation. Context: <describe team, decision, deadline, evidence links, owner, and known constraints>. Return the response brief using the output schema, mark assumptions, and list the human review gates before anyone acts.
