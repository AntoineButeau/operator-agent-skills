...
## Use when
Use this workflow when a pricing change needs operational planning across sales, support, finance, and product.

## Inputs
- Primary objective or decision to support
- new model, affected customers, timing, systems
...
## Output
a rollout plan with risks and review gates. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Pricing Change Rollout workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
