...
## Use when
Use this workflow when pricing decisions are being made before customer segments are clear.

## Inputs
- Primary objective or decision to support
- customer types, willingness to pay, usage patterns, sales motion
- Known constraints, deadlines, customers, sellers, finance, and product leaders, and risk tolerance
...
## Output
a segment map and pricing implications. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Pricing Segmentation Brief workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
