...
## Use when
Use this workflow when a company needs to choose or review seat, usage, outcome, or hybrid pricing.

## Inputs
- Primary objective or decision to support
- product value drivers, usage data, buyer expectations
...
## Output
a price metric scorecard and recommendation. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Price Metric Evaluator workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
