...
## Use when
Use this workflow when discounting patterns may reveal packaging, value, or sales process problems.

## Inputs
- Primary objective or decision to support
- discount data, deal notes, objections, segment data
...
## Output
a discount diagnosis and policy options. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Discount Signal Analysis workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
