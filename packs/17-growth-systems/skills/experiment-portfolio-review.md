...
## Use when
Use this workflow when growth experiments lack balance across risk, time horizon, and learning.

## Inputs
- Primary objective or decision to support
- experiment backlog, metrics, resources, history
...
## Output
a prioritized experiment portfolio. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Experiment Portfolio Review workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
