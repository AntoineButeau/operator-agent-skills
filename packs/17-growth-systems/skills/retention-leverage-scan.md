# Retention Lever Scan

## Use when
Use this workflow when you are working on growth systems that actually compound and need to diagnose the current state and name the operating risk. Its distinct job inside the Growth Loop Pack is to produce the risk-and-evidence audit; use the neighboring skills for Growth Loop Mapper, Experiment Portfolio Review, Compounding Channel Evaluator.
...
4. Separate this skill's job from the rest of the pack: deliver the risk-and-evidence audit, and list what should be routed to Growth Loop Mapper, Experiment Portfolio Review, Compounding Channel Evaluator.
