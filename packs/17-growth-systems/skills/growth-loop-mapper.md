...
## Use when
Use this workflow when you are working on growth systems that actually compound and need to make the system visible by mapping owners, flows, and evidence. Its distinct job inside the Growth Loop Pack is to produce the owner-and-flow map; use the neighboring skills for Experiment Portfolio Review, Retention Lever Scan, Compounding Channel Evaluator.
...
4. Separate this skill's job from the rest of the pack: deliver the owner-and-flow map, and list what should be routed to Experiment Portfolio Review, Retention Lever Scan, Compounding Channel Evaluator.
...
## Failure modes
- Producing a generic consultant summary instead of a decision-ready owner-and-flow map tied to growth loop.
- Treating stale dashboards, anecdotes, or meeting memory as facts without source-of-truth checks.
- Blurring this skill with Experiment Portfolio Review, Retention Lever Scan, Compounding Channel Evaluator, which creates duplicate work and hides the real owner.
