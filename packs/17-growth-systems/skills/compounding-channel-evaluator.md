...
## Use when
Use this workflow when a team needs channels that improve with use rather than reset each period.

## Inputs
- Primary objective or decision to support
- channel list, content/data assets, costs, conversion
- Known constraints, deadlines, customers, growth leads, analysts, and channel owners, and risk tolerance
...
## Output
a channel compounding assessment. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Compounding Channel Evaluator workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
