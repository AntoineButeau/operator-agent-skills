...
## Use when
Use this workflow when you are working on Work Design for the AI Era and need to produce a reusable decision brief or operating spec. Its distinct job inside the AI Work Design Pack is to produce the role redesign brief; use the neighboring skills for AI Work Allocation Map, Human-Agent Handoff Design, Work Design Risk Review.
...
- Domain signals to inspect: task bundle, capability shift, accountability, incentive, training need.
...
3. Inspect the domain mechanics for this pack: task bundle, capability shift, accountability, incentive, training need. Call out where handoffs, incentives, review gates, or decision rights break down.
4. Separate this skill's job from the rest of the pack: deliver the role redesign brief, and list what should be routed to AI Work Allocation Map, Human-Agent Handoff Design, Work Design Risk Review.
...
## Output
Return a role redesign brief with this schema:
- `use_case`: the specific operating situation and decision.
- `evidence`: facts, source links, missing data, and assumption flags.
- `diagnosis`: what is happening, why it matters, and which task bundle signal changed.
...
## Failure modes
- Producing a generic consultant summary instead of a decision-ready role redesign brief tied to task bundle.
- Treating stale dashboards, anecdotes, or meeting memory as facts without source-of-truth checks.
- Blurring this skill with AI Work Allocation Map, Human-Agent Handoff Design, Work Design Risk Review, which creates duplicate work and hides the real owner.
- Skipping the human review gate for commitments, sensitive people/customer data, or system-of-record changes.

## Example prompt
Run the Role Redesign Brief workflow for the following Work Design for the AI Era situation. Context: <describe team, decision, deadline, evidence links, owner, and known constraints>. Return the role redesign brief using the output schema, mark assumptions, and list the human review gates before anyone acts.
