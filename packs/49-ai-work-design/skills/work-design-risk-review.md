# Work Design Risk Review

## Use when
Use this workflow when you are working on Work Design for the AI Era and need to diagnose the current state and name the operating risk. Its distinct job inside the AI Work Design Pack is to produce the risk review; use the neighboring skills for AI Work Allocation Map, Human-Agent Handoff Design, Role Redesign Brief.
...
- Domain signals to inspect: automation surprise, deskilling risk, trust boundary, exception handling, measurement distortion.
...
3. Inspect the domain mechanics for this pack: automation surprise, deskilling risk, trust boundary, exception handling, measurement distortion. Call out where handoffs, incentives, review gates, or decision rights break down.
4. Separate this skill's job from the rest of the pack: deliver the risk review, and list what should be routed to AI Work Allocation Map, Human-Agent Handoff Design, Role Redesign Brief.
...
- `diagnosis`: what is happening, why it matters, and which automation surprise signal changed.
...
## Failure modes
- Producing a generic consultant summary instead of a decision-ready risk review tied to automation surprise.
- Treating stale dashboards, anecdotes, or meeting memory as facts without source-of-truth checks.
- Blurring this skill with AI Work Allocation Map, Human-Agent Handoff Design, Role Redesign Brief, which creates duplicate work and hides the real owner.
- Skipping the human review gate for commitments, sensitive people/customer data, or system-of-record changes.

## Example prompt
Run the Work Design Risk Review workflow for the following Work Design for the AI Era situation. Context: <describe team, decision, deadline, evidence links, owner, and known constraints>. Return the risk review using the output schema, mark assumptions, and list the human review gates before anyone acts.
