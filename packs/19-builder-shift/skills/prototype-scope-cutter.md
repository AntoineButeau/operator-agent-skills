...
## Use when
Use this workflow when an internal build should start small enough to validate fast.
...
## Output
a prototype scope and validation plan. Include the decision, owner, next action, review date, and open questions.
