...
## Use when
Use this workflow when operators see repeated manual work that could become internal tooling.
...
## Output
a ranked internal tool opportunity map. Include the decision, owner, next action, review date, and open questions.
