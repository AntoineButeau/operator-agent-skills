...
## Example prompt
Run the Operator to Builder Spec workflow for this situation: [paste context]. Return the artifact, the recommendation, and the questions a human should answer before acting.
