...
## Use when
Use this workflow when a non-engineering operator needs to specify a tool clearly enough to build or delegate.

## Inputs
- Primary objective or decision to support
- workflow, users, edge cases, data, permissions
...
## Output
a product-style internal tool spec. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Operator to Builder Spec workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
