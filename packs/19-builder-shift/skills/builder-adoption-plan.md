...
## Use when
Use this workflow when an internal tool needs adoption, support, and iteration planning.

## Inputs
- Primary objective or decision to support
- tool, target users, workflow change, support capacity
...
## Output
an adoption and feedback loop plan. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Builder Adoption Plan workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
