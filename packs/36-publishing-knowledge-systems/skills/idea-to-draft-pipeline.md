...
## Use when
Use this workflow when you are working on publishing & knowledge systems and need to handle the pipeline step without overlapping the other skills in the pack. Its distinct job inside the Publishing Pipeline Pack is to produce the revenue inspection brief; use the neighboring skills for Editorial Calendar Builder, Knowledge Asset Inventory, Publishing Quality Gate.
...
4. Separate this skill's job from the rest of the pack: deliver the revenue inspection brief, and list what should be routed to Editorial Calendar Builder, Knowledge Asset Inventory, Publishing Quality Gate.
...
## Failure modes
- Producing a generic consultant summary instead of a decision-ready revenue inspection brief tied to editorial calendar.
- Treating stale dashboards, anecdotes, or meeting memory as facts without source-of-truth checks.
- Blurring this skill with Editorial Calendar Builder, Knowledge Asset Inventory, Publishing Quality Gate, which creates duplicate work and hides the real owner.
