...
## Example prompt
Run the Idea to Draft Pipeline workflow for this situation: [paste context]. Return the artifact, the recommendation, and the questions a human should answer before acting.
