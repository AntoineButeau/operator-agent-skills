...
## Use when
Use this workflow when raw ideas need a reliable path into publishable drafts.

## Inputs
- Primary objective or decision to support
- idea list, audience, source notes, publishing goals
...
## Output
a draft pipeline and next actions. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Idea to Draft Pipeline workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
