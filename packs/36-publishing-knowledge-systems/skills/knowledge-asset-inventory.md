...
## Use when
Use this workflow when you are working on publishing & knowledge systems and need to make the system visible by mapping owners, flows, and evidence. Its distinct job inside the Publishing Pipeline Pack is to produce the owner-and-flow map; use the neighboring skills for Idea to Draft Pipeline, Editorial Calendar Builder, Publishing Quality Gate.
...
4. Separate this skill's job from the rest of the pack: deliver the owner-and-flow map, and list what should be routed to Idea to Draft Pipeline, Editorial Calendar Builder, Publishing Quality Gate.
