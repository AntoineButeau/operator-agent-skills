...
## Use when
Use this workflow when notes and drafts need organization into reusable intellectual assets.
...
## Output
a knowledge asset map. Include the decision, owner, next action, review date, and open questions.
