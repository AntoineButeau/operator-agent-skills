...
## Use when
Use this workflow when you are working on publishing & knowledge systems and need to produce a reusable artifact or operating spec. Its distinct job inside the Publishing Pipeline Pack is to produce the implementation-ready spec; use the neighboring skills for Idea to Draft Pipeline, Knowledge Asset Inventory, Publishing Quality Gate.
...
4. Separate this skill's job from the rest of the pack: deliver the implementation-ready spec, and list what should be routed to Idea to Draft Pipeline, Knowledge Asset Inventory, Publishing Quality Gate.
