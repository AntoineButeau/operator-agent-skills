...
## Use when
Use this workflow when publishing needs sequencing across themes, cadence, and capacity.

## Inputs
- Primary objective or decision to support
- topics, audience, dates, constraints, dependencies
...
## Output
an editorial calendar. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Editorial Calendar Builder workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
