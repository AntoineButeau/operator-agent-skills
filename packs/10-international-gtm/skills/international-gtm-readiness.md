# International GTM Readiness

## Use when
Use this workflow when you are working on internationalization & international go-to-market and need to handle the readiness step without overlapping the other skills in the pack. Its distinct job inside the Market Expansion Pack is to produce the international gtm readiness; use the neighboring skills for Market Selection Scorecard, Localization vs Adaptation Check, Market Entry Plan.
...
4. Separate this skill's job from the rest of the pack: deliver the international gtm readiness, and list what should be routed to Market Selection Scorecard, Localization vs Adaptation Check, Market Entry Plan.
...
## Output
Return a international gtm readiness with this schema:
...
## Failure modes
- Producing a generic consultant summary instead of a decision-ready international gtm readiness tied to market selection.
- Treating stale dashboards, anecdotes, or meeting memory as facts without source-of-truth checks.
- Blurring this skill with Market Selection Scorecard, Localization vs Adaptation Check, Market Entry Plan, which creates duplicate work and hides the real owner.
- Skipping the human review gate for commitments, sensitive people/customer data, or system-of-record changes.

## Example prompt
Run the International GTM Readiness workflow for the following Internationalization & International Go-To-Market situation. Context: <describe team, decision, deadline, evidence links, owner, and known constraints>. Return the international gtm readiness using the output schema, mark assumptions, and list the human review gates before anyone acts.
