...
## Use when
Use this workflow when you are working on internationalization & international go-to-market and need to turn the decision into sequenced work with gates and owners. Its distinct job inside the Market Expansion Pack is to produce the sequenced operating plan; use the neighboring skills for Market Selection Scorecard, Localization vs Adaptation Check, International GTM Readiness.
...
4. Separate this skill's job from the rest of the pack: deliver the sequenced operating plan, and list what should be routed to Market Selection Scorecard, Localization vs Adaptation Check, International GTM Readiness.
