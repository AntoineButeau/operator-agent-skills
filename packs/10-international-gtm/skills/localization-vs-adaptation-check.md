# Localization vs Adaptation Check

## Use when
Use this workflow when you are working on internationalization & international go-to-market and need to diagnose the current state and name the operating risk. Its distinct job inside the Market Expansion Pack is to produce the localization vs adaptation check; use the neighboring skills for Market Selection Scorecard, International GTM Readiness, Market Entry Plan.
...
4. Separate this skill's job from the rest of the pack: deliver the localization vs adaptation check, and list what should be routed to Market Selection Scorecard, International GTM Readiness, Market Entry Plan.
...
## Output
Return a localization vs adaptation check with this schema:
...
## Failure modes
- Producing a generic consultant summary instead of a decision-ready localization vs adaptation check tied to market selection.
- Treating stale dashboards, anecdotes, or meeting memory as facts without source-of-truth checks.
- Blurring this skill with Market Selection Scorecard, International GTM Readiness, Market Entry Plan, which creates duplicate work and hides the real owner.
- Skipping the human review gate for commitments, sensitive people/customer data, or system-of-record changes.

## Example prompt
Run the Localization vs Adaptation Check workflow for the following Internationalization & International Go-To-Market situation. Context: <describe team, decision, deadline, evidence links, owner, and known constraints>. Return the localization vs adaptation check using the output schema, mark assumptions, and list the human review gates before anyone acts.
