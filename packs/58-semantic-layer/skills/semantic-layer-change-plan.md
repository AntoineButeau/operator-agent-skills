# Semantic Layer Change Plan

## Use when
Use this workflow when you are working on The Semantic Layer: Where Business Meaning Becomes Infrastructure and need to turn the diagnosis into an executable plan with owners and gates. Its distinct job inside the Semantic Layer Pack is to produce the change plan; use the neighboring skills for Business Term Definition Map, Metric Semantic Audit, Meaning to Infrastructure Brief.
...
- Domain signals to inspect: definition migration, downstream report, stakeholder adoption, governance, versioning.
...
3. Inspect the domain mechanics for this pack: definition migration, downstream report, stakeholder adoption, governance, versioning. Call out where handoffs, incentives, review gates, or decision rights break down.
4. Separate this skill's job from the rest of the pack: deliver the change plan, and list what should be routed to Business Term Definition Map, Metric Semantic Audit, Meaning to Infrastructure Brief.
...
## Output
Return a change plan with this schema:
- `use_case`: the specific operating situation and decision.
- `evidence`: facts, source links, missing data, and assumption flags.
- `diagnosis`: what is happening, why it matters, and which definition migration signal changed.
...
## Failure modes
- Producing a generic consultant summary instead of a decision-ready change plan tied to definition migration.
- Treating stale dashboards, anecdotes, or meeting memory as facts without source-of-truth checks.
- Blurring this skill with Business Term Definition Map, Metric Semantic Audit, Meaning to Infrastructure Brief, which creates duplicate work and hides the real owner.
- Skipping the human review gate for commitments, sensitive people/customer data, or system-of-record changes.

## Example prompt
Run the Semantic Layer Change Plan workflow for the following The Semantic Layer: Where Business Meaning Becomes Infrastructure situation. Context: <describe team, decision, deadline, evidence links, owner, and known constraints>. Return the change plan using the output schema, mark assumptions, and list the human review gates before anyone acts.
