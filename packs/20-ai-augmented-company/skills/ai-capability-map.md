...
## Use when
Use this workflow when a company wants to identify where AI changes work, not just tools.

## Inputs
- Primary objective or decision to support
- functions, workflows, pain points, data access, risk
...
## Output
an AI capability map by function. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the AI Capability Map workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
