...
## Use when
Use this workflow when you are working on the ai-augmented company and need to make the system visible by mapping owners, flows, and evidence. Its distinct job inside the AI Transformation Pack is to produce the owner-and-flow map; use the neighboring skills for AI Capability Map, Team AI Readiness Review, AI Operating Policy Draft.
...
4. Separate this skill's job from the rest of the pack: deliver the owner-and-flow map, and list what should be routed to AI Capability Map, Team AI Readiness Review, AI Operating Policy Draft.
...
- Blurring this skill with AI Capability Map, Team AI Readiness Review, AI Operating Policy Draft, which creates duplicate work and hides the real owner.
- Skipping the human review gate for commitments, sensitive people/customer data, or system-of-record changes.

## Example prompt
Run the AI Transformation Roadmap workflow for the following The AI-Augmented Company situation. Context: <describe team, decision, deadline, evidence links, owner, and known constraints>. Return the owner-and-flow map using the output schema, mark assumptions, and list the human review gates before anyone acts.
