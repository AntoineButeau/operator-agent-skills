# Team AI Readiness Review

## Use when
Use this workflow when you are working on the ai-augmented company and need to diagnose the current state and name the operating risk. Its distinct job inside the AI Transformation Pack is to produce the risk-and-evidence audit; use the neighboring skills for AI Capability Map, AI Operating Policy Draft, AI Transformation Roadmap.
...
4. Separate this skill's job from the rest of the pack: deliver the risk-and-evidence audit, and list what should be routed to AI Capability Map, AI Operating Policy Draft, AI Transformation Roadmap.
