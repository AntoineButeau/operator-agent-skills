# AI Operating Policy Draft

## Use when
Use this workflow when you are working on the ai-augmented company and need to handle the draft step without overlapping the other skills in the pack. Its distinct job inside the AI Transformation Pack is to produce the ai operating policy draft; use the neighboring skills for AI Capability Map, Team AI Readiness Review, AI Transformation Roadmap.
...
4. Separate this skill's job from the rest of the pack: deliver the ai operating policy draft, and list what should be routed to AI Capability Map, Team AI Readiness Review, AI Transformation Roadmap.
...
## Output
Return a ai operating policy draft with this schema:
...
## Failure modes
- Producing a generic consultant summary instead of a decision-ready ai operating policy draft tied to AI capability map.
- Treating stale dashboards, anecdotes, or meeting memory as facts without source-of-truth checks.
- Blurring this skill with AI Capability Map, Team AI Readiness Review, AI Transformation Roadmap, which creates duplicate work and hides the real owner.
- Skipping the human review gate for commitments, sensitive people/customer data, or system-of-record changes.

## Example prompt
Run the AI Operating Policy Draft workflow for the following The AI-Augmented Company situation. Context: <describe team, decision, deadline, evidence links, owner, and known constraints>. Return the ai operating policy draft using the output schema, mark assumptions, and list the human review gates before anyone acts.
