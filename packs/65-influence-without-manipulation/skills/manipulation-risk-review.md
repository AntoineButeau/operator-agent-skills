...
## Use when
Use this workflow when you are working on Influence Without Manipulation and need to diagnose the current state and name the operating risk. Its distinct job inside the Ethical Influence Pack is to produce the manipulation risk review; use the neighboring skills for Influence Intent Check, Stakeholder Motivation Map, Ethical Persuasion Brief.
...
- Domain signals to inspect: withheld information, coercion, false urgency, dependency, consent.
...
3. Inspect the domain mechanics for this pack: withheld information, coercion, false urgency, dependency, consent. Call out where handoffs, incentives, review gates, or decision rights break down.
4. Separate this skill's job from the rest of the pack: deliver the manipulation risk review, and list what should be routed to Influence Intent Check, Stakeholder Motivation Map, Ethical Persuasion Brief.
...
## Output
Return a manipulation risk review with this schema:
- `use_case`: the specific operating situation and decision.
- `evidence`: facts, source links, missing data, and assumption flags.
- `diagnosis`: what is happening, why it matters, and which withheld information signal changed.
...
## Failure modes
- Producing a generic consultant summary instead of a decision-ready manipulation risk review tied to withheld information.
- Treating stale dashboards, anecdotes, or meeting memory as facts without source-of-truth checks.
- Blurring this skill with Influence Intent Check, Stakeholder Motivation Map, Ethical Persuasion Brief, which creates duplicate work and hides the real owner.
- Skipping the human review gate for commitments, sensitive people/customer data, or system-of-record changes.

## Example prompt
Run the Manipulation Risk Review workflow for the following Influence Without Manipulation situation. Context: <describe team, decision, deadline, evidence links, owner, and known constraints>. Return the manipulation risk review using the output schema, mark assumptions, and list the human review gates before anyone acts.
