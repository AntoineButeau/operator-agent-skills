# Ethical Persuasion Brief

## Use when
Use this workflow when you are working on Influence Without Manipulation and need to produce a reusable decision brief or operating spec. Its distinct job inside the Ethical Influence Pack is to produce the persuasion brief; use the neighboring skills for Influence Intent Check, Stakeholder Motivation Map, Manipulation Risk Review.
...
- Domain signals to inspect: case, evidence, audience value, choice architecture, objection.
...
3. Inspect the domain mechanics for this pack: case, evidence, audience value, choice architecture, objection. Call out where handoffs, incentives, review gates, or decision rights break down.
4. Separate this skill's job from the rest of the pack: deliver the persuasion brief, and list what should be routed to Influence Intent Check, Stakeholder Motivation Map, Manipulation Risk Review.
...
## Failure modes
- Producing a generic consultant summary instead of a decision-ready persuasion brief tied to case.
- Treating stale dashboards, anecdotes, or meeting memory as facts without source-of-truth checks.
- Blurring this skill with Influence Intent Check, Stakeholder Motivation Map, Manipulation Risk Review, which creates duplicate work and hides the real owner.
- Skipping the human review gate for commitments, sensitive people/customer data, or system-of-record changes.

## Example prompt
Run the Ethical Persuasion Brief workflow for the following Influence Without Manipulation situation. Context: <describe team, decision, deadline, evidence links, owner, and known constraints>. Return the persuasion brief using the output schema, mark assumptions, and list the human review gates before anyone acts.
