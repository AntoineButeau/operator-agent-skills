...
## Use when
Use this workflow when people are unclear who decides, recommends, executes, or escalates.

## Inputs
- Primary objective or decision to support
- recurring decisions, stakeholders, current pain points
...
## Output
a decision-rights matrix and operating notes. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Decision Rights Matrix workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
