...
## Use when
Use this workflow when work crosses teams and loses context, speed, or ownership.

## Inputs
- Primary objective or decision to support
- workflow steps, teams involved, artifacts, delays
...
## Output
a friction map with redesign options. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Handoff Friction Map workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
