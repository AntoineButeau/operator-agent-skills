...
## Use when
Use this workflow when teams are slow, confused, duplicated, or misaligned and structure may be the cause.
...
## Output
an org design diagnosis with structural hypotheses. Include the decision, owner, next action, review date, and open questions.
