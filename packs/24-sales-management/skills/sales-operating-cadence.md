...
## Use when
Use this workflow when sales team rituals need to connect coaching, pipeline, forecast, and learning.

## Inputs
- Primary objective or decision to support
- meeting list, metrics, goals, manager capacity
- Known constraints, deadlines, sellers, sales managers, customers, and revenue leaders, and risk tolerance
...
## Output
a sales management cadence. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Sales Operating Cadence workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
