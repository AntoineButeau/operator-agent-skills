...
## Use when
Use this workflow when you are working on sales management that actually works and need to turn the decision into sequenced work with gates and owners. Its distinct job inside the Sales Manager OS Pack is to produce the sequenced operating plan; use the neighboring skills for Pipeline Inspection Routine, Forecast Call Prep, Sales Operating Cadence.
...
4. Separate this skill's job from the rest of the pack: deliver the sequenced operating plan, and list what should be routed to Pipeline Inspection Routine, Forecast Call Prep, Sales Operating Cadence.
