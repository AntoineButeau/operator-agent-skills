...
## Use when
Use this workflow when a rep needs targeted coaching based on evidence, not vibes.

## Inputs
- Primary objective or decision to support
- calls, emails, conversion data, manager observations
...
## Output
a coaching plan with practice assignments. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Rep Coaching Plan workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
