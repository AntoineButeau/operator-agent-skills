...
## Use when
Use this workflow when a sales manager needs to inspect pipeline quality without micromanaging reps.

## Inputs
- Primary objective or decision to support
- pipeline report, deal notes, stage definitions, next steps
...
## Output
a pipeline inspection guide and deal review prompts. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Pipeline Inspection Routine workflow for this situation: [paste context]. Return the artifact, the recommendation, and the questions a human should answer before acting.
