...
## Use when
Use this workflow when you are working on sales management that actually works and need to produce a reusable artifact or operating spec. Its distinct job inside the Sales Manager OS Pack is to produce the revenue inspection brief; use the neighboring skills for Rep Coaching Plan, Forecast Call Prep, Sales Operating Cadence.
...
4. Separate this skill's job from the rest of the pack: deliver the revenue inspection brief, and list what should be routed to Rep Coaching Plan, Forecast Call Prep, Sales Operating Cadence.
