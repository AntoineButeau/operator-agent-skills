...
## Use when
Use this workflow when you are working on the full-stack company: vertical integration in the ai era and need to diagnose the current state and name the operating risk. Its distinct job inside the Vertical Integration Pack is to produce the risk-and-evidence audit; use the neighboring skills for Control Point Map, Build Buy Partner Brief, Vertical Integration Roadmap.
...
4. Separate this skill's job from the rest of the pack: deliver the risk-and-evidence audit, and list what should be routed to Control Point Map, Build Buy Partner Brief, Vertical Integration Roadmap.
