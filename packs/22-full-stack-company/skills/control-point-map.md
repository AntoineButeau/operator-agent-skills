...
## Use when
Use this workflow when you are working on the full-stack company: vertical integration in the ai era and need to make the system visible by mapping owners, flows, and evidence. Its distinct job inside the Vertical Integration Pack is to produce the owner-and-flow map; use the neighboring skills for Integration Boundary Audit, Build Buy Partner Brief, Vertical Integration Roadmap.
...
4. Separate this skill's job from the rest of the pack: deliver the owner-and-flow map, and list what should be routed to Integration Boundary Audit, Build Buy Partner Brief, Vertical Integration Roadmap.
