...
## Use when
Use this workflow when strategic leverage depends on owning specific parts of the stack.

## Inputs
- Primary objective or decision to support
- customer journey, supply chain, data flows, platform dependencies
...
## Output
a control-point map. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Control Point Map workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
