...
## Use when
Use this workflow when critical context lives in the founder’s head and needs transfer without bureaucracy.

## Inputs
- Primary objective or decision to support
- strategic beliefs, customer insights, decision patterns
...
## Output
a context packet for leaders. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Founder Context Capture workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
