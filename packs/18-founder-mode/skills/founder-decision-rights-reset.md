...
## Use when
Use this workflow when the founder must stay close to key calls while letting the org operate.
...
## Output
a decision rights reset plan. Include the decision, owner, next action, review date, and open questions.
