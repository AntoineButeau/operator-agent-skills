...
## Use when
Use this workflow when founder involvement needs intentional rituals instead of random intervention.

## Inputs
- Primary objective or decision to support
- existing meetings, feedback loops, product reviews
...
## Output
a ritual design that preserves taste and speed. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Scaling Founder Rituals workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
