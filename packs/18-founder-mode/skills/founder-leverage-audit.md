...
## Use when
Use this workflow when a founder is involved everywhere and needs to separate leverage from bottleneck behavior.

## Inputs
- Primary objective or decision to support
- calendar, decisions, escalations, team maturity
...
## Output
a founder leverage map. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Founder Leverage Audit workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
