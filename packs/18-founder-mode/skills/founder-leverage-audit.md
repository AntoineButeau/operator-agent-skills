...
## Use when
Use this workflow when you are working on founder mode that actually scales and need to diagnose the current state and name the operating risk. Its distinct job inside the Founder Operating Mode Pack is to produce the risk-and-evidence audit; use the neighboring skills for Founder Context Capture, Founder Decision Rights Reset, Scaling Founder Rituals.
...
4. Separate this skill's job from the rest of the pack: deliver the risk-and-evidence audit, and list what should be routed to Founder Context Capture, Founder Decision Rights Reset, Scaling Founder Rituals.
