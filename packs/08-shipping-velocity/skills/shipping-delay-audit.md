# Shipping Delay Audit

## Use when
Use this workflow when you are working on shipping velocity / how teams actually ship faster and need to diagnose the current state and name the operating risk. Its distinct job inside the Shipping System Pack is to produce the risk-and-evidence audit; use the neighboring skills for Scope Slicer, Rework Root Cause Review, Quality-Speed Tradeoff Check.
...
4. Separate this skill's job from the rest of the pack: deliver the risk-and-evidence audit, and list what should be routed to Scope Slicer, Rework Root Cause Review, Quality-Speed Tradeoff Check.
