...
## Use when
Use this workflow when a team ships slowly and needs to identify waiting, rework, or decision latency.

## Inputs
- Primary objective or decision to support
- recent work items, cycle times, blockers, approvals
...
## Output
a delay map and highest-leverage fix. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Shipping Delay Audit workflow for this situation: [paste context]. Return the artifact, the recommendation, and the questions a human should answer before acting.
