...
## Use when
Use this workflow when work keeps coming back because requirements, design, or alignment were weak.

## Inputs
- Primary objective or decision to support
- rework examples, review notes, handoff artifacts
...
## Output
a root-cause review and prevention checklist. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Rework Root Cause Review workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
