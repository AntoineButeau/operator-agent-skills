...
## Use when
Use this workflow when teams are framing speed and quality as opposites without diagnosing the actual constraint.

## Inputs
- Primary objective or decision to support
- defects, timelines, risk tolerance, customer impact
- Known constraints, deadlines, product, engineering, design, and launch partners, and risk tolerance
...
## Output
a balanced release recommendation. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Quality-Speed Tradeoff Check workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
