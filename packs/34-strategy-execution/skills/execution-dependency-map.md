...
## Use when
Use this workflow when you are working on strategy execution and need to make the system visible by mapping owners, flows, and evidence. Its distinct job inside the Strategy Translation Pack is to produce the owner-and-flow map; use the neighboring skills for Strategy to Work Map, Initiative Priority Check, Strategy Review Cadence.
...
4. Separate this skill's job from the rest of the pack: deliver the owner-and-flow map, and list what should be routed to Strategy to Work Map, Initiative Priority Check, Strategy Review Cadence.
...
- Blurring this skill with Strategy to Work Map, Initiative Priority Check, Strategy Review Cadence, which creates duplicate work and hides the real owner.
- Skipping the human review gate for commitments, sensitive people/customer data, or system-of-record changes.

## Example prompt
Run the Execution Dependency Map workflow for the following Strategy Execution situation. Context: <describe team, decision, deadline, evidence links, owner, and known constraints>. Return the owner-and-flow map using the output schema, mark assumptions, and list the human review gates before anyone acts.
