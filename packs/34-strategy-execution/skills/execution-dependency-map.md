...
## Use when
Use this workflow when delivery depends on cross-functional work that is not visible enough.

## Inputs
- Primary objective or decision to support
- initiatives, teams, milestones, blockers
...
## Output
a dependency map and risk list. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Execution Dependency Map workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
