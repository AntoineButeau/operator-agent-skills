...
## Use when
Use this workflow when strategy execution needs a review rhythm that learns and adjusts.

## Inputs
- Primary objective or decision to support
- goals, metrics, initiatives, leadership cadence
...
## Output
a strategy review agenda and artifact template. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Strategy Review Cadence workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
