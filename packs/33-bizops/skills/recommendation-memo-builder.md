...
## Use when
Use this workflow when analysis needs translation into a decision recommendation.

## Inputs
- Primary objective or decision to support
- findings, options, tradeoffs, risks
...
## Output
a recommendation memo. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Recommendation Memo Builder workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
