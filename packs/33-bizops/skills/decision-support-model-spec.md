...
## Use when
Use this workflow when a business decision needs a simple model or scenario analysis.
...
## Output
a model specification and sensitivity plan. Include the decision, owner, next action, review date, and open questions.
