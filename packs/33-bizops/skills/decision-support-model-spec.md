# Decision Support Model Spec

## Use when
Use this workflow when you are working on bizops / business operations and need to produce a reusable artifact or operating spec. Its distinct job inside the BizOps Decision Support Pack is to produce the implementation-ready spec; use the neighboring skills for BizOps Problem Framing, Operational Deep Dive Plan, Recommendation Memo Builder.
...
4. Separate this skill's job from the rest of the pack: deliver the implementation-ready spec, and list what should be routed to BizOps Problem Framing, Operational Deep Dive Plan, Recommendation Memo Builder.
