...
## Use when
Use this workflow when a messy business problem needs structure before analysis.
...
## Output
a crisp problem frame and analysis plan. Include the decision, owner, next action, review date, and open questions.
