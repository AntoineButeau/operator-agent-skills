...
## Use when
Use this workflow when an area of the business needs investigation across data and workflows.

## Inputs
- Primary objective or decision to support
- area, metrics, process, owners, symptoms
...
## Output
a deep-dive plan and interview guide. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Operational Deep Dive Plan workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
