...
## Use when
Use this workflow when process or system changes need governance without slowing revenue work.

## Inputs
- Primary objective or decision to support
- change request, impacted teams, data dependencies
...
## Output
a RevOps change plan and approval gates. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the RevOps Change Control workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
