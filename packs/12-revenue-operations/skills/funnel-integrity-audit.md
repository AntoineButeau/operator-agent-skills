...
## Use when
Use this workflow when pipeline data or handoffs are unreliable across marketing, sales, and success.
...
## Output
a funnel integrity report and cleanup plan. Include the decision, owner, next action, review date, and open questions.
