...
## Use when
Use this workflow when you are working on revenue operations and need to diagnose the current state and name the operating risk. Its distinct job inside the RevOps System Pack is to produce the revenue inspection brief; use the neighboring skills for Funnel Integrity Audit, GTM Handoff Map, RevOps Change Control.
...
4. Separate this skill's job from the rest of the pack: deliver the revenue inspection brief, and list what should be routed to Funnel Integrity Audit, GTM Handoff Map, RevOps Change Control.
