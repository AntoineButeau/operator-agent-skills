...
## Use when
Use this workflow when forecast accuracy is poor or confidence is unclear.

## Inputs
- Primary objective or decision to support
- pipeline data, forecast categories, deal notes, history
...
## Output
a forecast quality diagnosis. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Forecast Reliability Review workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
