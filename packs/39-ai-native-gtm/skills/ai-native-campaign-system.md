...
## Use when
Use this workflow when campaigns need personalization and iteration through AI-enabled workflows.

## Inputs
- Primary objective or decision to support
- ICP, offer, content assets, channels, guardrails
...
## Output
a campaign operating system spec. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the AI-Native Campaign System workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
