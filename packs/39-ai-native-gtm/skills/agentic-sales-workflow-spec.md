...
## Use when
Use this workflow when sales work needs redesign around agents, automation, and human judgment.
...
## Output
an agentic sales workflow specification. Include the decision, owner, next action, review date, and open questions.
