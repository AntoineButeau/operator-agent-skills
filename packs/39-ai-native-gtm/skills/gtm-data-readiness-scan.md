...
## Use when
Use this workflow when AI-native GTM depends on clean, accessible, governed data.
...
## Output
a GTM data readiness report. Include the decision, owner, next action, review date, and open questions.
