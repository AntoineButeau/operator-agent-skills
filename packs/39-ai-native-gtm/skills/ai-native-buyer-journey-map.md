...
## Use when
Use this workflow when you are working on ai-native gtm and need to make the system visible by mapping owners, flows, and evidence. Its distinct job inside the AI-Native GTM Pack is to produce the owner-and-flow map; use the neighboring skills for Agentic Sales Workflow Spec, GTM Data Readiness Scan, AI-Native Campaign System.
...
4. Separate this skill's job from the rest of the pack: deliver the owner-and-flow map, and list what should be routed to Agentic Sales Workflow Spec, GTM Data Readiness Scan, AI-Native Campaign System.
...
## Failure modes
- Producing a generic consultant summary instead of a decision-ready owner-and-flow map tied to agentic sales workflow.
- Treating stale dashboards, anecdotes, or meeting memory as facts without source-of-truth checks.
- Blurring this skill with Agentic Sales Workflow Spec, GTM Data Readiness Scan, AI-Native Campaign System, which creates duplicate work and hides the real owner.
- Skipping the human review gate for commitments, sensitive people/customer data, or system-of-record changes.

## Example prompt
Run the AI-Native Buyer Journey Map workflow for the following AI-Native GTM situation. Context: <describe team, decision, deadline, evidence links, owner, and known constraints>. Return the owner-and-flow map using the output schema, mark assumptions, and list the human review gates before anyone acts.
