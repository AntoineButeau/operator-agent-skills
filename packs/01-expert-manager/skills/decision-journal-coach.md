...
## Use when
Use this workflow when a manager wants accountability and learning without blame after important calls.

## Inputs
- Primary objective or decision to support
- decision context, options considered, chosen path, expected signals
...
## Output
a decision journal entry and review prompts. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Decision Journal Coach workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
