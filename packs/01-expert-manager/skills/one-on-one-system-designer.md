...
## Use when
Use this workflow when 1:1s are drifting into status reporting instead of coaching, alignment, and risk discovery.
...
## Output
a reusable 1:1 agenda, question bank, and follow-up system. Include the decision, owner, next action, review date, and open questions.
