...
## Use when
Use this workflow when manager entering a new team needs to understand people, priorities, decision rights, and risk before changing the system.
...
## Output
a 30/60/90 operating brief with risks, trust moves, and decision calendar. Include the decision, owner, next action, review date, and open questions.
