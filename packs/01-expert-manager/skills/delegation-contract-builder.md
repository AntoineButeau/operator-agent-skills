...
## Use when
Use this workflow when work needs to move from manager-owned to team-owned without ambiguity or hidden control loops.

## Inputs
- Primary objective or decision to support
- task or domain, owner, quality bar, decision rights, escalation triggers
...
## Output
a delegation contract with ownership boundaries and review cadence. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Delegation Contract Builder workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
