...
## Use when
Use this workflow when a system is underperforming and optimization is scattered.

## Inputs
- Primary objective or decision to support
- goal, process, bottlenecks, queues, resource limits
...
## Output
a ranked constraint diagnosis and focus plan. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Constraint Finder workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
