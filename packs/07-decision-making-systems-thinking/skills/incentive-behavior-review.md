...
## Use when
Use this workflow when you are working on decision making & systems thinking and need to diagnose the current state and name the operating risk. Its distinct job inside the Judgment System Pack is to produce the risk-and-evidence audit; use the neighboring skills for Decision Type Classifier, Second-Order Effects Scan, Constraint Finder.
...
4. Separate this skill's job from the rest of the pack: deliver the risk-and-evidence audit, and list what should be routed to Decision Type Classifier, Second-Order Effects Scan, Constraint Finder.
