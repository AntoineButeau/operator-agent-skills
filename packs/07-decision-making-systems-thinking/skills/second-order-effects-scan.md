...
## Use when
Use this workflow when a proposed action may create unintended consequences across a system.
...
## Output
a second-order effects map and mitigation list. Include the decision, owner, next action, review date, and open questions.
