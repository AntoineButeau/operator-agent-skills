...
## Use when
Use this workflow when an AI capability may create trust, safety, legal, or UX risk.

## Inputs
- Primary objective or decision to support
- feature spec, users, outputs, controls, context
...
## Output
a risk register and mitigation plan. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the AI Product Risk Review workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
