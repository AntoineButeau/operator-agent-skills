...
## Use when
Use this workflow when an AI feature needs evaluation criteria before launch.

## Inputs
- Primary objective or decision to support
- feature, expected behavior, edge cases, failure costs
...
## Output
an evaluation plan with test cases and thresholds. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Model Behavior Evaluation Plan workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
