# Model Behavior Evaluation Plan

## Use when
Use this workflow when you are working on building ai products and need to turn the decision into sequenced work with gates and owners. Its distinct job inside the AI Product Pack is to produce the sequenced operating plan; use the neighboring skills for AI Use Case Qualification, AI Product Risk Review, AI Feature Launch Plan.
...
4. Separate this skill's job from the rest of the pack: deliver the sequenced operating plan, and list what should be routed to AI Use Case Qualification, AI Product Risk Review, AI Feature Launch Plan.
