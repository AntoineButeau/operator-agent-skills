...
## Use when
Use this workflow when a product idea uses AI and needs validation beyond novelty.
...
## Output
a qualified AI use-case brief. Include the decision, owner, next action, review date, and open questions.
