...
## Use when
Use this workflow when a completed effort should be reviewed for agency lessons.

## Inputs
- Primary objective or decision to support
- outcome, obstacles, choices, delays
...
## Output
a retrospective with agency lessons and habits. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the High-Agency Retrospective workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
