# High-Agency Retrospective

## Use when
Use this workflow when you are working on agency / high agency and need to produce a reusable artifact or operating spec. Its distinct job inside the Agency Training Pack is to produce the implementation-ready spec; use the neighboring skills for Agency Gap Diagnosis, Constraint Reframe Drill, Owner Mindset Plan.
...
4. Separate this skill's job from the rest of the pack: deliver the implementation-ready spec, and list what should be routed to Agency Gap Diagnosis, Constraint Reframe Drill, Owner Mindset Plan.
