...
## Use when
Use this workflow when you are working on agency / high agency and need to turn the decision into sequenced work with gates and owners. Its distinct job inside the Agency Training Pack is to produce the sequenced operating plan; use the neighboring skills for Agency Gap Diagnosis, Constraint Reframe Drill, High-Agency Retrospective.
...
4. Separate this skill's job from the rest of the pack: deliver the sequenced operating plan, and list what should be routed to Agency Gap Diagnosis, Constraint Reframe Drill, High-Agency Retrospective.
...
## Failure modes
- Producing a generic consultant summary instead of a decision-ready sequenced operating plan tied to agency gap.
- Treating stale dashboards, anecdotes, or meeting memory as facts without source-of-truth checks.
- Blurring this skill with Agency Gap Diagnosis, Constraint Reframe Drill, High-Agency Retrospective, which creates duplicate work and hides the real owner.
- Skipping the human review gate for commitments, sensitive people/customer data, or system-of-record changes.

## Example prompt
Run the Owner Mindset Plan workflow for the following Agency / High Agency situation. Context: <describe team, decision, deadline, evidence links, owner, and known constraints>. Return the sequenced operating plan using the output schema, mark assumptions, and list the human review gates before anyone acts.
