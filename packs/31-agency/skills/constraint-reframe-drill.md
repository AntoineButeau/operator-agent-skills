...
## Use when
Use this workflow when a blocker needs conversion into options under constraints.
...
## Output
a reframed option set. Include the decision, owner, next action, review date, and open questions.
