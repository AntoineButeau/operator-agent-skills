...
## Use when
Use this workflow when an IC or lead needs to update a manager with signal instead of activity.

## Inputs
- Primary objective or decision to support
- current work, risks, asks, decisions needed, confidence level
...
## Output
a concise manager update with context, interpretation, and requested action. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Manager Trust Update workflow for this situation: [paste context]. Return the artifact, the recommendation, and the questions a human should answer before acting.
