...
## Use when
Use this workflow when you need to disagree with a senior person without creating unnecessary friction.

## Inputs
- Primary objective or decision to support
- proposal, concern, evidence, alternatives, stakes
...
## Output
a respectful disagreement memo with decision framing. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Upward Disagreement Brief workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
