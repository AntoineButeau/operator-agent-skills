...
## Use when
Use this workflow when you are unsure whether to handle an issue locally or escalate it.

## Inputs
- Primary objective or decision to support
- issue, blast radius, reversibility, stakeholders, time sensitivity
...
## Output
an escalation recommendation and message draft. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Escalation Judgment Check workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
