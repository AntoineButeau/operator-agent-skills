...
## Use when
Use this workflow when official priorities do not match the manager’s actual attention and tradeoffs.
...
## Output
a map of revealed priorities and how to align work. Include the decision, owner, next action, review date, and open questions.
