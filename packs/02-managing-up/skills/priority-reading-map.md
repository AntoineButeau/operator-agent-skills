...
## Use when
Use this workflow when you are working on managing up and need to make the system visible by mapping owners, flows, and evidence. Its distinct job inside the Upward Signal Pack is to produce the owner-and-flow map; use the neighboring skills for Manager Trust Update, Upward Disagreement Brief, Escalation Judgment Check.
...
4. Separate this skill's job from the rest of the pack: deliver the owner-and-flow map, and list what should be routed to Manager Trust Update, Upward Disagreement Brief, Escalation Judgment Check.
...
## Failure modes
- Producing a generic consultant summary instead of a decision-ready owner-and-flow map tied to manager trust ledger.
- Treating stale dashboards, anecdotes, or meeting memory as facts without source-of-truth checks.
- Blurring this skill with Manager Trust Update, Upward Disagreement Brief, Escalation Judgment Check, which creates duplicate work and hides the real owner.
- Skipping the human review gate for commitments, sensitive people/customer data, or system-of-record changes.

## Example prompt
Run the Priority Reading Map workflow for the following Managing Up situation. Context: <describe team, decision, deadline, evidence links, owner, and known constraints>. Return the owner-and-flow map using the output schema, mark assumptions, and list the human review gates before anyone acts.
