# Implementation Ownership Architecture

## Use when
Use this workflow when work in this pack specifically requires **implementation ownership architecture** and a concrete operator-grade artifact. Use it as one step in the pack progression, not as a generic strategy brainstorm.
...
## Example prompt
Run `implementation-ownership-architecture` using the provided context. Return the defined output schema, mark assumptions, and recommend the smallest next evidence-backed move.
