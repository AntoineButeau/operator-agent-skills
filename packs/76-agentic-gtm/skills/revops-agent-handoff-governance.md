# RevOps Agent Handoff Governance

## Use when
Use this workflow when work in this pack specifically requires **revops agent handoff governance** and a concrete operator-grade artifact. Use it as one step in the pack progression, not as a generic strategy brainstorm.
...
## Example prompt
Run `revops-agent-handoff-governance` using the provided context. Return the defined output schema, mark assumptions, and recommend the smallest next evidence-backed move.
