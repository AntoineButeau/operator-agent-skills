# GTM Loop Inventory Prioritization

## Use when
Use this workflow when work in this pack specifically requires **gtm loop inventory prioritization** and a concrete operator-grade artifact. Use it as one step in the pack progression, not as a generic strategy brainstorm.
...
## Example prompt
Run `gtm-loop-inventory-prioritization` using the provided context. Return the defined output schema, mark assumptions, and recommend the smallest next evidence-backed move.
