...
## Use when
Use this workflow when formal org charts do not explain how work actually moves.
...
## Output
an influence map. Include the decision, owner, next action, review date, and open questions.
