...
## Use when
Use this workflow when you are working on power that actually moves work and need to make the system visible by mapping owners, flows, and evidence. Its distinct job inside the Power Map Pack is to produce the owner-and-flow map; use the neighboring skills for Power Risk Review, Coalition Building Plan, Political Friction Diagnosis.
...
4. Separate this skill's job from the rest of the pack: deliver the owner-and-flow map, and list what should be routed to Power Risk Review, Coalition Building Plan, Political Friction Diagnosis.
