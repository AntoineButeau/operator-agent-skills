# Political Friction Diagnosis

## Use when
Use this workflow when you are working on power that actually moves work and need to diagnose the current state and name the operating risk. Its distinct job inside the Power Map Pack is to produce the risk-and-evidence audit; use the neighboring skills for Influence Network Map, Power Risk Review, Coalition Building Plan.
...
4. Separate this skill's job from the rest of the pack: deliver the risk-and-evidence audit, and list what should be routed to Influence Network Map, Power Risk Review, Coalition Building Plan.
