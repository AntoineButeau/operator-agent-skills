...
## Use when
Use this workflow when work is stuck for reasons that are not visible in project plans.

## Inputs
- Primary objective or decision to support
- delays, objections, stakeholder behavior, history
...
## Output
a diagnosis of political friction and next moves. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Political Friction Diagnosis workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
