...
## Use when
Use this workflow when you are working on power that actually moves work and need to turn the decision into sequenced work with gates and owners. Its distinct job inside the Power Map Pack is to produce the sequenced operating plan; use the neighboring skills for Influence Network Map, Power Risk Review, Political Friction Diagnosis.
...
- Domain signals to inspect: influence network, coalition, political friction, sponsor map, power risk.
...
3. Inspect the domain mechanics for this pack: influence network, coalition, political friction, sponsor map, power risk. Call out where handoffs, incentives, review gates, or decision rights break down.
4. Separate this skill's job from the rest of the pack: deliver the sequenced operating plan, and list what should be routed to Influence Network Map, Power Risk Review, Political Friction Diagnosis.
...
- `diagnosis`: what is happening, why it matters, and which influence network signal changed.
