...
## Use when
Use this workflow when an initiative needs support before formal approval.

## Inputs
- Primary objective or decision to support
- initiative, supporters, skeptics, must-win stakeholders
...
## Output
a coalition plan. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Coalition Building Plan workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
