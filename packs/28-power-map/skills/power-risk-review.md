...
## Use when
Use this workflow when a plan may fail because it ignores incentives, status, or control points.

## Inputs
- Primary objective or decision to support
- proposal, stakeholders, affected power, decision forums
...
## Output
a power risk memo. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Power Risk Review workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
