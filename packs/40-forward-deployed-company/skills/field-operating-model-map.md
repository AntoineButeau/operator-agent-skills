# Field Operating Model Map

## Use when
Use this workflow when you are working on The Forward-Deployed Company and need to make the system visible by mapping owners, flows, and evidence. Its distinct job inside the Forward-Deployed Company Pack is to produce the owner-and-flow map; use the neighboring skills for Embedded Team Scope Brief, Customer Feedback Loop Design, Deployment Risk Review.
...
- Domain signals to inspect: deployment model, customer proximity, embedded teams, feedback loop, escalation path.
...
3. Inspect the domain mechanics for this pack: deployment model, customer proximity, embedded teams, feedback loop, escalation path. Call out where handoffs, incentives, review gates, or decision rights break down.
4. Separate this skill's job from the rest of the pack: deliver the owner-and-flow map, and list what should be routed to Embedded Team Scope Brief, Customer Feedback Loop Design, Deployment Risk Review.
...
- `diagnosis`: what is happening, why it matters, and which deployment model signal changed.
