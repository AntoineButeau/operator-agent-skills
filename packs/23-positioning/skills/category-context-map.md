...
## Use when
Use this workflow when a product needs clearer market context and competitive frame.

## Inputs
- Primary objective or decision to support
- buyers, alternatives, market language, use cases
...
## Output
a category and alternative map. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Category Context Map workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
