...
## Use when
Use this workflow when sales, marketing, or product pages are saying different things.

## Inputs
- Primary objective or decision to support
- current messages, buyer feedback, win/loss notes
...
## Output
a message consistency diagnosis. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Message Confusion Audit workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
