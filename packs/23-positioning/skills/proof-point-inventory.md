...
## Use when
Use this workflow when claims need evidence before becoming external messaging.

## Inputs
- Primary objective or decision to support
- claims, customer examples, data, objections
...
## Output
a proof-point inventory with gaps. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Proof Point Inventory workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
