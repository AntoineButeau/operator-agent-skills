# Strategic Illegibility Check

## Use when
Use this workflow when you are working on legibility and illegibility for operators and need to diagnose the current state and name the operating risk. Its distinct job inside the Legibility Operator Pack is to produce the strategic illegibility check; use the neighboring skills for Legibility Audit, Visibility System Design, Legible Decision Package.
...
- Domain signals to inspect: visibility system, legible decision package, strategic illegibility, audit trail, decision rights.
...
3. Inspect the domain mechanics for this pack: visibility system, legible decision package, strategic illegibility, audit trail, decision rights. Call out where handoffs, incentives, review gates, or decision rights break down.
4. Separate this skill's job from the rest of the pack: deliver the strategic illegibility check, and list what should be routed to Legibility Audit, Visibility System Design, Legible Decision Package.
...
## Output
Return a strategic illegibility check with this schema:
- `use_case`: the specific operating situation and decision.
- `evidence`: facts, source links, missing data, and assumption flags.
- `diagnosis`: what is happening, why it matters, and which visibility system signal changed.
...
## Failure modes
- Producing a generic consultant summary instead of a decision-ready strategic illegibility check tied to visibility system.
- Treating stale dashboards, anecdotes, or meeting memory as facts without source-of-truth checks.
- Blurring this skill with Legibility Audit, Visibility System Design, Legible Decision Package, which creates duplicate work and hides the real owner.
- Skipping the human review gate for commitments, sensitive people/customer data, or system-of-record changes.

## Example prompt
Run the Strategic Illegibility Check workflow for the following Legibility and Illegibility for Operators situation. Context: <describe team, decision, deadline, evidence links, owner, and known constraints>. Return the strategic illegibility check using the output schema, mark assumptions, and list the human review gates before anyone acts.
