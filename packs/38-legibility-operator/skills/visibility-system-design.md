...
## Use when
Use this workflow when you are working on legibility and illegibility for operators and need to produce a reusable artifact or operating spec. Its distinct job inside the Legibility Operator Pack is to produce the visibility system design; use the neighboring skills for Legibility Audit, Strategic Illegibility Check, Legible Decision Package.
...
4. Separate this skill's job from the rest of the pack: deliver the visibility system design, and list what should be routed to Legibility Audit, Strategic Illegibility Check, Legible Decision Package.
...
## Output
Return a visibility system design with this schema:
...
## Failure modes
- Producing a generic consultant summary instead of a decision-ready visibility system design tied to visibility system.
- Treating stale dashboards, anecdotes, or meeting memory as facts without source-of-truth checks.
- Blurring this skill with Legibility Audit, Strategic Illegibility Check, Legible Decision Package, which creates duplicate work and hides the real owner.
- Skipping the human review gate for commitments, sensitive people/customer data, or system-of-record changes.

## Example prompt
Run the Visibility System Design workflow for the following Legibility and Illegibility for Operators situation. Context: <describe team, decision, deadline, evidence links, owner, and known constraints>. Return the visibility system design using the output schema, mark assumptions, and list the human review gates before anyone acts.
