...
## Use when
Use this workflow when a team needs visibility that reduces confusion without creating reporting theater.

## Inputs
- Primary objective or decision to support
- audiences, decisions, artifacts, cadence
...
## Output
a visibility system spec. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Visibility System Design workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
