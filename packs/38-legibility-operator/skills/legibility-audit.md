...
## Use when
Use this workflow when you are working on legibility and illegibility for operators and need to diagnose the current state and name the operating risk. Its distinct job inside the Legibility Operator Pack is to produce the risk-and-evidence audit; use the neighboring skills for Strategic Illegibility Check, Visibility System Design, Legible Decision Package.
...
4. Separate this skill's job from the rest of the pack: deliver the risk-and-evidence audit, and list what should be routed to Strategic Illegibility Check, Visibility System Design, Legible Decision Package.
