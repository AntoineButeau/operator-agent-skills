# Legible Decision Package

## Use when
Use this workflow when you are working on legibility and illegibility for operators and need to handle the package step without overlapping the other skills in the pack. Its distinct job inside the Legibility Operator Pack is to produce the legible decision package; use the neighboring skills for Legibility Audit, Strategic Illegibility Check, Visibility System Design.
...
4. Separate this skill's job from the rest of the pack: deliver the legible decision package, and list what should be routed to Legibility Audit, Strategic Illegibility Check, Visibility System Design.
...
## Output
Return a legible decision package with this schema:
...
## Failure modes
- Producing a generic consultant summary instead of a decision-ready legible decision package tied to visibility system.
- Treating stale dashboards, anecdotes, or meeting memory as facts without source-of-truth checks.
- Blurring this skill with Legibility Audit, Strategic Illegibility Check, Visibility System Design, which creates duplicate work and hides the real owner.
- Skipping the human review gate for commitments, sensitive people/customer data, or system-of-record changes.

## Example prompt
Run the Legible Decision Package workflow for the following Legibility and Illegibility for Operators situation. Context: <describe team, decision, deadline, evidence links, owner, and known constraints>. Return the legible decision package using the output schema, mark assumptions, and list the human review gates before anyone acts.
