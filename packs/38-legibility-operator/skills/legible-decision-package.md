...
## Use when
Use this workflow when a decision needs enough context for others to understand and support it.

## Inputs
- Primary objective or decision to support
- decision, rationale, evidence, tradeoffs, owner
...
## Output
a decision package. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Legible Decision Package workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
