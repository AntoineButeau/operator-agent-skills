# Review Cadence Redesign

## Use when
Use this workflow when you are working on Operating Reviews That Actually Drive Decisions and need to design the operating artifact, interface, or workflow contract. Its distinct job inside the Operating Review Pack is to produce the cadence redesign; use the neighboring skills for Operating Review Agenda Builder, Decision Followthrough Audit, Metric Narrative Review.
...
- Domain signals to inspect: meeting rhythm, audience, artifact, decision right, review load.
...
3. Inspect the domain mechanics for this pack: meeting rhythm, audience, artifact, decision right, review load. Call out where handoffs, incentives, review gates, or decision rights break down.
4. Separate this skill's job from the rest of the pack: deliver the cadence redesign, and list what should be routed to Operating Review Agenda Builder, Decision Followthrough Audit, Metric Narrative Review.
...
## Output
Return a cadence redesign with this schema:
- `use_case`: the specific operating situation and decision.
- `evidence`: facts, source links, missing data, and assumption flags.
- `diagnosis`: what is happening, why it matters, and which meeting rhythm signal changed.
...
## Failure modes
- Producing a generic consultant summary instead of a decision-ready cadence redesign tied to meeting rhythm.
- Treating stale dashboards, anecdotes, or meeting memory as facts without source-of-truth checks.
- Blurring this skill with Operating Review Agenda Builder, Decision Followthrough Audit, Metric Narrative Review, which creates duplicate work and hides the real owner.
- Skipping the human review gate for commitments, sensitive people/customer data, or system-of-record changes.

## Example prompt
Run the Review Cadence Redesign workflow for the following Operating Reviews That Actually Drive Decisions situation. Context: <describe team, decision, deadline, evidence links, owner, and known constraints>. Return the cadence redesign using the output schema, mark assumptions, and list the human review gates before anyone acts.
