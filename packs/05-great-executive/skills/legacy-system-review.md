...
## Use when
Use this workflow when an executive wants to build systems that outlast their direct involvement.

## Inputs
- Primary objective or decision to support
- current dependencies, decision rights, rituals, documentation
...
## Output
a leverage map and institution-building plan. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Legacy System Review workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
