...
## Use when
Use this workflow when a leadership team needs continuous talent judgment rather than annual surprises.

## Inputs
- Primary objective or decision to support
- role expectations, performance evidence, growth signals, risks
...
## Output
a calibration brief and next-step actions. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Talent Calibration Loop workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
