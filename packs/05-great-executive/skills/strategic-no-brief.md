...
## Use when
Use this workflow when leadership needs to decline work without sounding arbitrary or political.

## Inputs
- Primary objective or decision to support
- request, strategy, opportunity cost, stakeholder impact
...
## Output
a clear no memo with rationale and alternatives. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Strategic No Brief workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
