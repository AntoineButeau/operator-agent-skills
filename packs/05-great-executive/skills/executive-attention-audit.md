...
## Use when
Use this workflow when an executive needs to decide where their attention has the highest leverage.
...
## Output
an attention allocation plan and stop-doing list. Include the decision, owner, next action, review date, and open questions.
