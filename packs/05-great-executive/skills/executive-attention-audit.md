# Executive Attention Audit

## Use when
Use this workflow when you are working on being a great executive and need to diagnose the current state and name the operating risk. Its distinct job inside the Executive Attention Pack is to produce the risk-and-evidence audit; use the neighboring skills for Strategic No Brief, Talent Calibration Loop, Legacy System Review.
...
4. Separate this skill's job from the rest of the pack: deliver the risk-and-evidence audit, and list what should be routed to Strategic No Brief, Talent Calibration Loop, Legacy System Review.
