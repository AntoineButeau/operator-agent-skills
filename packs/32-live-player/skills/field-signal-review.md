...
## Use when
Use this workflow when you are working on how to be a live player and need to diagnose the current state and name the operating risk. Its distinct job inside the Reality Contact Pack is to produce the risk-and-evidence audit; use the neighboring skills for Reality Contact Audit, Assumption Refresh Loop, Live Option Generator.
...
4. Separate this skill's job from the rest of the pack: deliver the risk-and-evidence audit, and list what should be routed to Reality Contact Audit, Assumption Refresh Loop, Live Option Generator.
...
- Blurring this skill with Reality Contact Audit, Assumption Refresh Loop, Live Option Generator, which creates duplicate work and hides the real owner.
- Skipping the human review gate for commitments, sensitive people/customer data, or system-of-record changes.

## Example prompt
Run the Field Signal Review workflow for the following How to Be a Live Player situation. Context: <describe team, decision, deadline, evidence links, owner, and known constraints>. Return the risk-and-evidence audit using the output schema, mark assumptions, and list the human review gates before anyone acts.
