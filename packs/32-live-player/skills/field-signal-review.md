...
## Use when
Use this workflow when frontline signals need conversion into strategy or operating changes.
...
## Output
a field signal interpretation memo. Include the decision, owner, next action, review date, and open questions.
