...
## Use when
Use this workflow when a person or team may be relying on stale assumptions instead of current reality.

## Inputs
- Primary objective or decision to support
- beliefs, evidence, customer signals, recent changes
...
## Output
a reality-contact audit. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Reality Contact Audit workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
