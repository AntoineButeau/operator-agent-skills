# Reality Contact Audit

## Use when
Use this workflow when you are working on how to be a live player and need to diagnose the current state and name the operating risk. Its distinct job inside the Reality Contact Pack is to produce the risk-and-evidence audit; use the neighboring skills for Assumption Refresh Loop, Live Option Generator, Field Signal Review.
...
4. Separate this skill's job from the rest of the pack: deliver the risk-and-evidence audit, and list what should be routed to Assumption Refresh Loop, Live Option Generator, Field Signal Review.
...
## Failure modes
- Producing a generic consultant summary instead of a decision-ready risk-and-evidence audit tied to field signal.
- Treating stale dashboards, anecdotes, or meeting memory as facts without source-of-truth checks.
- Blurring this skill with Assumption Refresh Loop, Live Option Generator, Field Signal Review, which creates duplicate work and hides the real owner.
- Skipping the human review gate for commitments, sensitive people/customer data, or system-of-record changes.

## Example prompt
Run the Reality Contact Audit workflow for the following How to Be a Live Player situation. Context: <describe team, decision, deadline, evidence links, owner, and known constraints>. Return the risk-and-evidence audit using the output schema, mark assumptions, and list the human review gates before anyone acts.
