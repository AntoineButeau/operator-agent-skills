...
## Use when
Use this workflow when strategic assumptions need regular testing and updating.
...
## Output
an assumption refresh loop. Include the decision, owner, next action, review date, and open questions.
