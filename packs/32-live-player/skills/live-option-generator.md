...
## Use when
Use this workflow when a situation needs creative moves beyond inherited playbooks.

## Inputs
- Primary objective or decision to support
- objective, constraints, current playbook, available assets
...
## Output
a set of live options and experiments. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Live Option Generator workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
