# Platform Investment Brief

## Use when
Use this workflow when you are working on Platform Strategy and need to produce a reusable decision brief or operating spec. Its distinct job inside the Platform Strategy Pack is to produce the investment brief; use the neighboring skills for Platform Boundary Map, Ecosystem Incentive Review, Platform Governance Plan.
...
- Domain signals to inspect: platform capability, reuse case, adoption path, cost, strategic leverage.
...
3. Inspect the domain mechanics for this pack: platform capability, reuse case, adoption path, cost, strategic leverage. Call out where handoffs, incentives, review gates, or decision rights break down.
4. Separate this skill's job from the rest of the pack: deliver the investment brief, and list what should be routed to Platform Boundary Map, Ecosystem Incentive Review, Platform Governance Plan.
...
## Output
Return a investment brief with this schema:
- `use_case`: the specific operating situation and decision.
- `evidence`: facts, source links, missing data, and assumption flags.
- `diagnosis`: what is happening, why it matters, and which platform capability signal changed.
...
## Failure modes
- Producing a generic consultant summary instead of a decision-ready investment brief tied to platform capability.
- Treating stale dashboards, anecdotes, or meeting memory as facts without source-of-truth checks.
- Blurring this skill with Platform Boundary Map, Ecosystem Incentive Review, Platform Governance Plan, which creates duplicate work and hides the real owner.
- Skipping the human review gate for commitments, sensitive people/customer data, or system-of-record changes.

## Example prompt
Run the Platform Investment Brief workflow for the following Platform Strategy situation. Context: <describe team, decision, deadline, evidence links, owner, and known constraints>. Return the investment brief using the output schema, mark assumptions, and list the human review gates before anyone acts.
