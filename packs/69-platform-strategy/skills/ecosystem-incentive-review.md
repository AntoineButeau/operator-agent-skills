# Ecosystem Incentive Review

## Use when
Use this workflow when you are working on Platform Strategy and need to diagnose the current state and name the operating risk. Its distinct job inside the Platform Strategy Pack is to produce the ecosystem incentive review; use the neighboring skills for Platform Boundary Map, Platform Investment Brief, Platform Governance Plan.
...
- Domain signals to inspect: developer incentive, partner value, user benefit, platform tax, trust.
...
3. Inspect the domain mechanics for this pack: developer incentive, partner value, user benefit, platform tax, trust. Call out where handoffs, incentives, review gates, or decision rights break down.
4. Separate this skill's job from the rest of the pack: deliver the ecosystem incentive review, and list what should be routed to Platform Boundary Map, Platform Investment Brief, Platform Governance Plan.
...
## Output
Return a ecosystem incentive review with this schema:
- `use_case`: the specific operating situation and decision.
- `evidence`: facts, source links, missing data, and assumption flags.
- `diagnosis`: what is happening, why it matters, and which developer incentive signal changed.
...
## Failure modes
- Producing a generic consultant summary instead of a decision-ready ecosystem incentive review tied to developer incentive.
- Treating stale dashboards, anecdotes, or meeting memory as facts without source-of-truth checks.
- Blurring this skill with Platform Boundary Map, Platform Investment Brief, Platform Governance Plan, which creates duplicate work and hides the real owner.
- Skipping the human review gate for commitments, sensitive people/customer data, or system-of-record changes.

## Example prompt
Run the Ecosystem Incentive Review workflow for the following Platform Strategy situation. Context: <describe team, decision, deadline, evidence links, owner, and known constraints>. Return the ecosystem incentive review using the output schema, mark assumptions, and list the human review gates before anyone acts.
