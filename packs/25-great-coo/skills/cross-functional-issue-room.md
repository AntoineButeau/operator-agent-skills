...
## Use when
Use this workflow when a recurring issue crosses teams and needs a structured resolution process.

## Inputs
- Primary objective or decision to support
- issue, affected teams, data, owners, deadlines
...
## Output
an issue room brief and cadence. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Cross-Functional Issue Room workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
