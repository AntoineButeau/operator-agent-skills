...
## Use when
Use this workflow when a COO needs to understand how strategy becomes execution across the company.

## Inputs
- Primary objective or decision to support
- strategy, functions, cadences, metrics, decision forums
...
## Output
an operating model map. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Company Operating Model Map workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
