# Company Operating Model Map

## Use when
Use this workflow when you are working on how to be a great coo: the operating system behind the company and need to make the system visible by mapping owners, flows, and evidence. Its distinct job inside the COO Operating Model Pack is to produce the owner-and-flow map; use the neighboring skills for Cross-Functional Issue Room, Execution Risk Register, COO Operating Dashboard.
...
4. Separate this skill's job from the rest of the pack: deliver the owner-and-flow map, and list what should be routed to Cross-Functional Issue Room, Execution Risk Register, COO Operating Dashboard.
