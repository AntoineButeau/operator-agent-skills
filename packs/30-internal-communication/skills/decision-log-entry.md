...
## Use when
Use this workflow when a decision needs to be remembered and searchable after the meeting ends.

## Inputs
- Primary objective or decision to support
- decision, rationale, alternatives, owner, implications
...
## Output
a decision log entry. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Decision Log Entry workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
