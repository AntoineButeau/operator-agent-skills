...
## Use when
Use this workflow when you are working on internal communication that actually works: how companies move context, decisions, and signal without drowning in noise and need to diagnose the current state and name the operating risk. Its distinct job inside the Company Signal Pack is to produce the risk-and-evidence audit; use the neighboring skills for Company Signal Brief, Decision Log Entry, Context Package Builder.
...
4. Separate this skill's job from the rest of the pack: deliver the risk-and-evidence audit, and list what should be routed to Company Signal Brief, Decision Log Entry, Context Package Builder.
