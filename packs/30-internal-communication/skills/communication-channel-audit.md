...
## Use when
Use this workflow when messages are scattered across too many channels or rituals.

## Inputs
- Primary objective or decision to support
- channels, message types, pain points, audience needs
- Known constraints, deadlines, employees, managers, operators, and communication owners, and risk tolerance
...
## Output
a channel purpose map and cleanup plan. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Communication Channel Audit workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
