# Trust Lineage Reversibility Controls

## Use when
Use this workflow when work in this pack specifically requires **trust lineage reversibility controls** and a concrete operator-grade artifact. Use it as one step in the pack progression, not as a generic strategy brainstorm.
...
## Example prompt
Run `trust-lineage-reversibility-controls` using the provided context. Return the defined output schema, mark assumptions, and recommend the smallest next evidence-backed move.
