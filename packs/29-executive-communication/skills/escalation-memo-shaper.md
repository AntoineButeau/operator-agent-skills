...
## Use when
Use this workflow when a hard issue needs escalation without drama or blame.

## Inputs
- Primary objective or decision to support
- issue, impact, options, owner, deadline
...
## Output
an escalation memo with clear asks. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Escalation Memo Shaper workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
