# Executive Memo Builder

## Use when
Use this workflow when you are working on executive communication that creates clarity: how leaders use memos, updates, narratives, and escalations to help organizations decide and need to produce a reusable artifact or operating spec. Its distinct job inside the Executive Clarity Pack is to produce the operator memo; use the neighboring skills for Narrative Arc Review, Escalation Memo Shaper, Executive Update Compressor.
...
4. Separate this skill's job from the rest of the pack: deliver the operator memo, and list what should be routed to Narrative Arc Review, Escalation Memo Shaper, Executive Update Compressor.
