...
## Use when
Use this workflow when a decision or strategy needs executive-level clarity in writing.

## Inputs
- Primary objective or decision to support
- context, decision, options, evidence, recommendation
...
## Output
a structured executive memo. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Executive Memo Builder workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
