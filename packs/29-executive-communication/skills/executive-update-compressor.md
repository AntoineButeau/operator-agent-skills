...
## Use when
Use this workflow when an update needs to be shorter, sharper, and more decision-oriented.

## Inputs
- Primary objective or decision to support
- draft update, audience, key changes, asks
- Known constraints, deadlines, executives, operators, reviewers, and affected teams, and risk tolerance
...
## Output
a compressed executive update. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Executive Update Compressor workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
