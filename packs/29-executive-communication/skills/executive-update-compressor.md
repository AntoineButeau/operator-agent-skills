# Executive Update Compressor

## Use when
Use this workflow when you are working on executive communication that creates clarity: how leaders use memos, updates, narratives, and escalations to help organizations decide and need to compress the situation into a decision-ready brief. Its distinct job inside the Executive Clarity Pack is to produce the operator memo; use the neighboring skills for Executive Memo Builder, Narrative Arc Review, Escalation Memo Shaper.
...
4. Separate this skill's job from the rest of the pack: deliver the operator memo, and list what should be routed to Executive Memo Builder, Narrative Arc Review, Escalation Memo Shaper.
