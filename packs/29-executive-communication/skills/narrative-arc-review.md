...
## Use when
Use this workflow when an executive narrative feels scattered or fails to create alignment.

## Inputs
- Primary objective or decision to support
- draft, audience, desired decision, stakes
...
## Output
a revised narrative arc. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Narrative Arc Review workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
