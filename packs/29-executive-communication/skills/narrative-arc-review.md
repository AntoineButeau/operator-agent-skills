...
## Use when
Use this workflow when you are working on executive communication that creates clarity: how leaders use memos, updates, narratives, and escalations to help organizations decide and need to diagnose the current state and name the operating risk. Its distinct job inside the Executive Clarity Pack is to produce the risk-and-evidence audit; use the neighboring skills for Executive Memo Builder, Escalation Memo Shaper, Executive Update Compressor.
...
4. Separate this skill's job from the rest of the pack: deliver the risk-and-evidence audit, and list what should be routed to Executive Memo Builder, Escalation Memo Shaper, Executive Update Compressor.
