...
## Use when
Use this workflow when a product or business plan has hidden technical risks.
...
## Output
an architecture risk memo. Include the decision, owner, next action, review date, and open questions.
