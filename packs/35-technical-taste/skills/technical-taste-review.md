...
## Use when
Use this workflow when a leader needs to judge whether a technical proposal has good taste and pragmatism.

## Inputs
- Primary objective or decision to support
- proposal, user impact, maintenance burden, alternatives
...
## Output
a taste review scorecard. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Technical Taste Review workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
