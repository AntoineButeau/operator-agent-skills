...
## Use when
Use this workflow when a non-engineering leader needs to understand a technical tradeoff.
...
## Output
a plain-English technical decision brief. Include the decision, owner, next action, review date, and open questions.
