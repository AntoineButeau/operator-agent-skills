# AI Code Review Context Pack

## Use when
Use this workflow when you are working on technical literacy / technical taste and need to diagnose the current state and name the operating risk. Its distinct job inside the Technical Taste Pack is to produce the risk-and-evidence audit; use the neighboring skills for Technical Decision Brief, Architecture Risk Scan, Technical Taste Review.
...
4. Separate this skill's job from the rest of the pack: deliver the risk-and-evidence audit, and list what should be routed to Technical Decision Brief, Architecture Risk Scan, Technical Taste Review.
