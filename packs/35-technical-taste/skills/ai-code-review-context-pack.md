...
## Use when
Use this workflow when an operator wants an AI agent to review code with business context.
...
## Output
a context pack for delegated technical review. Include the decision, owner, next action, review date, and open questions.
