...
## Use when
Use this workflow when roles need to change as agents automate tasks and expand operator leverage.

## Inputs
- Primary objective or decision to support
- role list, workflows, AI tools, outcomes
...
## Output
a redesigned role charter. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the AI-Era Role Redesign workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
