# AI-Era Role Redesign

## Use when
Use this workflow when you are working on operating structure for the ai era and need to produce a reusable artifact or operating spec. Its distinct job inside the AI Org Design Pack is to produce the ai-era role redesign; use the neighboring skills for Agent-Human Boundary Map, AI Governance Cadence, Org Capability Shift Plan.
...
4. Separate this skill's job from the rest of the pack: deliver the ai-era role redesign, and list what should be routed to Agent-Human Boundary Map, AI Governance Cadence, Org Capability Shift Plan.
...
## Output
Return a ai-era role redesign with this schema:
...
## Failure modes
- Producing a generic consultant summary instead of a decision-ready ai-era role redesign tied to agent-human boundary.
- Treating stale dashboards, anecdotes, or meeting memory as facts without source-of-truth checks.
- Blurring this skill with Agent-Human Boundary Map, AI Governance Cadence, Org Capability Shift Plan, which creates duplicate work and hides the real owner.
- Skipping the human review gate for commitments, sensitive people/customer data, or system-of-record changes.

## Example prompt
Run the AI-Era Role Redesign workflow for the following Operating Structure for the AI Era situation. Context: <describe team, decision, deadline, evidence links, owner, and known constraints>. Return the ai-era role redesign using the output schema, mark assumptions, and list the human review gates before anyone acts.
