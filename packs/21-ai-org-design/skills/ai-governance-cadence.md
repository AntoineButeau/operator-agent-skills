...
## Use when
Use this workflow when you are working on operating structure for the ai era and need to handle the cadence step without overlapping the other skills in the pack. Its distinct job inside the AI Org Design Pack is to produce the ai governance cadence; use the neighboring skills for AI-Era Role Redesign, Agent-Human Boundary Map, Org Capability Shift Plan.
...
4. Separate this skill's job from the rest of the pack: deliver the ai governance cadence, and list what should be routed to AI-Era Role Redesign, Agent-Human Boundary Map, Org Capability Shift Plan.
...
## Output
Return a ai governance cadence with this schema:
...
## Failure modes
- Producing a generic consultant summary instead of a decision-ready ai governance cadence tied to agent-human boundary.
- Treating stale dashboards, anecdotes, or meeting memory as facts without source-of-truth checks.
- Blurring this skill with AI-Era Role Redesign, Agent-Human Boundary Map, Org Capability Shift Plan, which creates duplicate work and hides the real owner.
- Skipping the human review gate for commitments, sensitive people/customer data, or system-of-record changes.

## Example prompt
Run the AI Governance Cadence workflow for the following Operating Structure for the AI Era situation. Context: <describe team, decision, deadline, evidence links, owner, and known constraints>. Return the ai governance cadence using the output schema, mark assumptions, and list the human review gates before anyone acts.
