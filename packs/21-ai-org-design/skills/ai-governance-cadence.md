...
## Use when
Use this workflow when AI work needs review without blocking experimentation.

## Inputs
- Primary objective or decision to support
- AI initiatives, risks, owners, metrics
...
## Output
a governance cadence and decision forum. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the AI Governance Cadence workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
