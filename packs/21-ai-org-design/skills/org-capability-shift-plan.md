...
## Use when
Use this workflow when the organization needs new skills, norms, and structures for AI-native work.

## Inputs
- Primary objective or decision to support
- current capabilities, gaps, strategic priorities
- Known constraints, deadlines, human operators, agent owners, managers, and reviewers, and risk tolerance
...
## Output
a capability shift plan. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Org Capability Shift Plan workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
