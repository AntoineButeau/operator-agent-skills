# Org Capability Shift Plan

## Use when
Use this workflow when you are working on operating structure for the ai era and need to turn the decision into sequenced work with gates and owners. Its distinct job inside the AI Org Design Pack is to produce the sequenced operating plan; use the neighboring skills for AI-Era Role Redesign, Agent-Human Boundary Map, AI Governance Cadence.
...
- Domain signals to inspect: agent-human boundary, AI governance cadence, role redesign, capability shift, review board.
...
3. Inspect the domain mechanics for this pack: agent-human boundary, AI governance cadence, role redesign, capability shift, review board. Call out where handoffs, incentives, review gates, or decision rights break down.
4. Separate this skill's job from the rest of the pack: deliver the sequenced operating plan, and list what should be routed to AI-Era Role Redesign, Agent-Human Boundary Map, AI Governance Cadence.
...
## Output
Return a sequenced operating plan with this schema:
- `use_case`: the specific operating situation and decision.
- `evidence`: facts, source links, missing data, and assumption flags.
- `diagnosis`: what is happening, why it matters, and which agent-human boundary signal changed.
...
## Failure modes
- Producing a generic consultant summary instead of a decision-ready sequenced operating plan tied to agent-human boundary.
- Treating stale dashboards, anecdotes, or meeting memory as facts without source-of-truth checks.
- Blurring this skill with AI-Era Role Redesign, Agent-Human Boundary Map, AI Governance Cadence, which creates duplicate work and hides the real owner.
- Skipping the human review gate for commitments, sensitive people/customer data, or system-of-record changes.

## Example prompt
Run the Org Capability Shift Plan workflow for the following Operating Structure for the AI Era situation. Context: <describe team, decision, deadline, evidence links, owner, and known constraints>. Return the sequenced operating plan using the output schema, mark assumptions, and list the human review gates before anyone acts.
