...
## Use when
Use this workflow when work needs clear division between agents, humans, and systems.

## Inputs
- Primary objective or decision to support
- workflow, risk, judgment needs, tools
...
## Output
a boundary map and escalation model. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Agent-Human Boundary Map workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
