# Agent-Human Boundary Map

## Use when
Use this workflow when you are working on operating structure for the ai era and need to make the system visible by mapping owners, flows, and evidence. Its distinct job inside the AI Org Design Pack is to produce the owner-and-flow map; use the neighboring skills for AI-Era Role Redesign, AI Governance Cadence, Org Capability Shift Plan.
...
4. Separate this skill's job from the rest of the pack: deliver the owner-and-flow map, and list what should be routed to AI-Era Role Redesign, AI Governance Cadence, Org Capability Shift Plan.
