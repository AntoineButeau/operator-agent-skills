...
## Use when
Use this workflow when you are working on Mastery Is an Operating System and need to turn the diagnosis into an executable plan with owners and gates. Its distinct job inside the Mastery Operating System Pack is to produce the deliberate practice plan; use the neighboring skills for Mastery Loop Map, Feedback Quality Review, Skill Progression Scorecard.
...
- Domain signals to inspect: practice rep, constraint, coach signal, review cadence, error pattern.
...
3. Inspect the domain mechanics for this pack: practice rep, constraint, coach signal, review cadence, error pattern. Call out where handoffs, incentives, review gates, or decision rights break down.
4. Separate this skill's job from the rest of the pack: deliver the deliberate practice plan, and list what should be routed to Mastery Loop Map, Feedback Quality Review, Skill Progression Scorecard.
...
## Output
Return a deliberate practice plan with this schema:
- `use_case`: the specific operating situation and decision.
- `evidence`: facts, source links, missing data, and assumption flags.
- `diagnosis`: what is happening, why it matters, and which practice rep signal changed.
...
## Failure modes
- Producing a generic consultant summary instead of a decision-ready deliberate practice plan tied to practice rep.
- Treating stale dashboards, anecdotes, or meeting memory as facts without source-of-truth checks.
- Blurring this skill with Mastery Loop Map, Feedback Quality Review, Skill Progression Scorecard, which creates duplicate work and hides the real owner.
- Skipping the human review gate for commitments, sensitive people/customer data, or system-of-record changes.

## Example prompt
Run the Deliberate Practice Plan workflow for the following Mastery Is an Operating System situation. Context: <describe team, decision, deadline, evidence links, owner, and known constraints>. Return the deliberate practice plan using the output schema, mark assumptions, and list the human review gates before anyone acts.
