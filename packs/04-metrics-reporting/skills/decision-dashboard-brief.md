# Decision Dashboard Brief

## Use when
Use this workflow when you are working on goals / metrics / dashboards / reporting and need to compress the situation into a decision-ready brief. Its distinct job inside the Decision Metrics Pack is to produce the metric decision brief; use the neighboring skills for Metric Quality Audit, Weekly Report Upgrade, Metric Owner Map.
...
4. Separate this skill's job from the rest of the pack: deliver the metric decision brief, and list what should be routed to Metric Quality Audit, Weekly Report Upgrade, Metric Owner Map.
