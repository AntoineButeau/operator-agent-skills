...
## Use when
Use this workflow when a dashboard needs to help people decide, not admire numbers.
...
## Output
a dashboard spec organized around decisions and exception handling. Include the decision, owner, next action, review date, and open questions.
