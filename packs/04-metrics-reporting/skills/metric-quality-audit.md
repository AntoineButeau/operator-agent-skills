...
## Use when
Use this workflow when a metric may be vanity, gameable, lagging, or disconnected from decisions.

## Inputs
- Primary objective or decision to support
- metric definition, audience, behavior it drives, decisions it informs
...
## Output
a metric risk assessment and redesign options. Include the decision, owner, next action, review date, and open questions.
...
## Example prompt
Run the Metric Quality Audit workflow for this situation: the current context below. Return the artifact, the recommendation, and the questions a human should answer before acting.
