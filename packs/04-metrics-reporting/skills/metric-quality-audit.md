...
## Use when
Use this workflow when you are working on goals / metrics / dashboards / reporting and need to diagnose the current state and name the operating risk. Its distinct job inside the Decision Metrics Pack is to produce the metric decision brief; use the neighboring skills for Decision Dashboard Brief, Weekly Report Upgrade, Metric Owner Map.
...
4. Separate this skill's job from the rest of the pack: deliver the metric decision brief, and list what should be routed to Decision Dashboard Brief, Weekly Report Upgrade, Metric Owner Map.
...
- Blurring this skill with Decision Dashboard Brief, Weekly Report Upgrade, Metric Owner Map, which creates duplicate work and hides the real owner.
