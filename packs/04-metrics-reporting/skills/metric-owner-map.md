...
## Use when
Use this workflow when you are working on goals / metrics / dashboards / reporting and need to make the system visible by mapping owners, flows, and evidence. Its distinct job inside the Decision Metrics Pack is to produce the metric decision brief; use the neighboring skills for Metric Quality Audit, Decision Dashboard Brief, Weekly Report Upgrade.
...
4. Separate this skill's job from the rest of the pack: deliver the metric decision brief, and list what should be routed to Metric Quality Audit, Decision Dashboard Brief, Weekly Report Upgrade.
...
- Blurring this skill with Metric Quality Audit, Decision Dashboard Brief, Weekly Report Upgrade, which creates duplicate work and hides the real owner.
